...
- yarn add @types/node @types/react @types/react-dom @types/jest @types/react-redux
- yarn add @types/url-parse @types/file-saver
** Server steps
*** s3
...
- yarn add 'https://gitpkg.now.sh/bracedotto/blockstack-react-native/BlockstackSDK?f9c87be6f642964be760e9f6a7b4af15f79116dd'
- yarn add reselect
