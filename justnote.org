...
- yarn add @react-navigation/routers@5.4.9
- yarn add @react-navigation/core@5.12.0
- yarn add @react-navigation/native@5.7.0
- yarn add @react-navigation/stack@5.6.2
- yarn add react-native-modal@6.5.0
...
- yarn add git+https://github.com/wordpress-mobile/react-native-keyboard-aware-scroll-view.git#ef97e80a89041e3b8563e7d4dca00f2222180ff4
...
- yarn add git+https://github.com/wordpress-mobile/react-native-video.git#9bcb723e5755678a69fcb7d0a17145e50a475e9f
...
- yarn add ../../../gutenberg/packages/base-styles
- yarn add ../../../gutenberg/packages/format-library
- yarn add ../../../gutenberg/packages/edit-post
- yarn add ../../../gutenberg/packages/react-native-bridge
