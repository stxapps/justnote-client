...
- npm i file:../../../blockstack-react-native/BlockstackSDK
...
- ios
  ...
  + targets: Justnote, on General:
    ~ update Version, App Category: Productivity, Display Name: Justnote
  ...
  + targets: SavetoJustnote, on General:
    ~ update Version, Miminum iOS, Display Name: Save to Justnote
...
* Next
** Install
- npx create-next-app@latest justnotecc
...
- npm i url-parse file-saver @wewatch/lexorank blueimp-load-image idb-keyval queue
