...
class ShareViewController: UIViewController {
  ...
  private func processRequest() {
    ...
    // For all attachments, find text first then url. Firefox provides 2 attachments: first text, second url.
  ...
  private func addNote(_ text: String) {
    ...
    Blockstack.shared.addNote(text) { publicUrl, error in
  ...
  private func renderAdding() {
    DispatchQueue.main.async {
      ...
      s.append(NSMutableAttributedString(string: "Justnote", attributes: [NSAttributedString.Key.font: self.semiBoldTextLg, NSAttributedString.Key.foregroundColor: self.gray800]))
  ...
  private func renderInvalid() {
    DispatchQueue.main.async {
      ...
      text.textColor = self.gray600
      text.textAlignment = NSTextAlignment.center
      text.text = "No text found to save to Justnote"
