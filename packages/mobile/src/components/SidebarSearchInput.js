  ...
  return (
    <View style={tailwind('mt-6 hidden pl-3 pr-1 lg:flex')}>
      <View style={tailwind('mt-1 rounded-md bg-white shadow-sm')}>
        ...
        <TextInput onChange={onSearchInputChange} style={tailwind(`w-full rounded-md border border-gray-300 pl-9 pr-6 text-sm font-normal leading-4 text-gray-700 ${searchInputClasses}`)} placeholder="Search" placeholderTextColor="rgb(113, 128, 150)" value={searchString} autoCapitalize="none" />
