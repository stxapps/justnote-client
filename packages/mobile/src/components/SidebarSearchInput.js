    ...
    <View style={tailwind('mt-6 hidden pl-3 pr-1 lg:flex')}>
      <View style={tailwind('mt-1 rounded-md bg-white shadow-sm blk:bg-gray-800')}>
        ...
        <TouchableOpacity onPress={onSearchClearBtnClick} style={tailwind(`inset-y-0 right-0 justify-center pr-2 ${searchClearBtnClasses}`)}>
          <Svg width={20} height={20} style={tailwind('rounded-full font-normal text-gray-400 blk:text-gray-400')} viewBox="0 0 20 20" fill="currentColor">
