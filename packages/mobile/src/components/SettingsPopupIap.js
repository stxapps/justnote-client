...
const IapHome = (props) => {
    ...
    if (purchaseStatus === null) {
      ...
      actionPanel = (
        <View style={tailwind('mt-6 items-start justify-start')}>
          <TouchableOpacity onPress={onRequestBtnClick} style={tailwind('rounded-md border border-gray-400 bg-white px-3.5 py-1.5 shadow-sm')}>
  ...
  return (
    <View style={tailwind('mt-6 mb-4 md:mt-0')}>
      ...
      <Text style={tailwind('mt-4 text-base font-normal text-gray-500 leading-6.5')}>Justnote is free and we offer a paid subscription for use of extra features. It's our intention to never show advertisments and we don't rent, sell or share your information with other companies. Our optional paid subscription is the only way we make money.</Text>
      <Text style={tailwind('mt-4 text-base font-normal text-gray-500 leading-6.5')}>Support us and unlock extra features: pin to the top and dark appearance.</Text>
...
const IapPurchased = (props) => {
  ...
  if (purchase.source === APPSTORE) {
    ...
    appStoreLink = (
      <Text onPress={() => Linking.openURL('https://play.google.com/store/account/subscriptions?sku=com.justnotecc.supporter&package=com.justnotecc')} style={tailwind('text-base font-normal text-gray-500 underline leading-6.5')}>Google Play</Text>
    );
  }
  ...
  if (purchase.status === ACTIVE) {
    infoText = (
      <React.Fragment>
        <View style={tailwind('mt-4')}>
          <Text style={tailwind('text-base font-normal text-gray-500 leading-6.5')}>     <Text style={tailwind('text-base font-normal text-green-600 leading-6.5')}>Thank you very much for supporting us.</Text> You've unlocked extra features: pin to the top and dark appearance.</Text>
    ...
    infoText = (
      <React.Fragment>
        <Text style={tailwind('mt-4 text-base font-normal text-gray-500 leading-6.5')}>Thank you very much for supporting us. You've unlocked extra features: pin to the top and dark appearance.</Text>
    ...
    infoText = (
      <React.Fragment>
        <Text style={tailwind('mt-4 text-base font-normal text-gray-500 leading-6.5')}>Thank you very much for supporting us. You've unlocked extra features: pin to the top and dark appearance.</Text>
        <View style={tailwind('mt-4')}>
          <Text style={tailwind('text-base font-normal text-gray-500 leading-6.5')}>     <Text style={tailwind('text-base font-normal text-red-600 leading-6.5')}>Your subscription has been expired</Text> and you won't be able to use extra features soon. Please go to {appStoreLink} now to renew your subscription to continue supporting us and using extra features.</Text>
          <View style={[tailwind('absolute'), { top: 3, left: 0 }]}>
    ...
    infoText = (
      <React.Fragment>
        ...
        <View style={tailwind('mt-4')}>
          <Text style={tailwind('text-base font-normal text-gray-500 leading-6.5')}>     <Text style={tailwind('text-base font-normal text-red-600 leading-6.5')}>Your subscription has been expired.</Text> Please go to {appStoreLink} now to renew your subscription to continue supporting us and using extra features.
          </Text>
          <View style={[tailwind('absolute'), { top: 3, left: 0 }]}>
            <Svg style={tailwind('font-normal text-red-500')} width={20} height={20} viewBox="0 0 20 20" fill="currentColor">
              <Path fillRule="evenodd" clipRule="evenodd" d="M18 10C18 14.4183 14.4183 18 10 18C5.58172 18 2 14.4183 2 10C2 5.58172 5.58172 2 10 2C14.4183 2 18 5.58172 18 10ZM11 14C11 14.5523 10.5523 15 10 15C9.44772 15 9 14.5523 9 14C9 13.4477 9.44772 13 10 13C10.5523 13 11 13.4477 11 14ZM10 5C9.44772 5 9 5.44772 9 6V10C9 10.5523 9.44772 11 10 11C10.5523 11 11 10.5523 11 10V6C11 5.44772 10.5523 5 10 5Z" />
  ...
  if (restoreStatus === null) {
    actionPanel = (
      <View style={tailwind('mt-7 mb-4 items-start justify-start')}>
        <TouchableOpacity onPress={onRestoreBtnClick} style={tailwind('rounded-md border border-gray-400 bg-white px-3.5 py-1.5 shadow-sm')}>
