...
const IapHome = (props) => {
  ...
  return (
    <View style={tailwind('mt-6 mb-4 md:mt-0')}>
      ...
      <Text style={tailwind('mt-4 text-base font-normal leading-6.5 text-gray-500 blk:text-gray-400')}>Support us and unlock extra features: pin to the top, dark appearance, custom date format, section by month, more font sizes, and lock lists & notes.</Text>
...
const IapPurchased = (props) => {
  ...
  if (purchase.status === ACTIVE) {
    ...
    infoText = (
      <React.Fragment>
        <Text style={tailwind('mt-4 text-base font-normal leading-6.5 text-gray-500 blk:text-gray-400')}>Thank you very much for supporting us. You've unlocked extra features: pin to the top, dark appearance, custom date format, section by month, more font sizes, and lock lists & notes.</Text>
