...
const SettingsPopup = () => {
  ...
  const _render = (content) => {
    ...
    return (
      <View {...viewPanResponder.panHandlers} style={cache('SP_modal', [tailwind('absolute inset-0 bg-white'), modalStyle], [insets.top, insets.bottom, insets.left, insets.right])}>
