  ...
  if (!exportAllDataProgress) {
    ...
    actionPanel = (
      <View style={tailwind('mt-6 mb-4')}>
        ...
        <Text style={tailwind('mt-6 text-base text-gray-500 font-normal leading-6.5')}>Please wait a moment and try again. If the problem persists, please <Text onPress={() => Linking.openURL('https://justnote.cc/' + HASH_SUPPORT)} style={tailwind('text-base text-gray-500 font-normal underline')}>contact us</Text>
