  ...
  return (
    <View style={tailwind('p-4 md:p-6 md:pt-4', safeAreaWidth)}>
      ...
      <View style={tailwind('mt-8')}>
        ...
        <Text style={tailwind('mt-2.5 text-base text-gray-500 font-normal leading-6.5')}>Import data from a zip file. Please go to <Text onPress={() => Linking.openURL(DOMAIN_NAME)} style={tailwind('text-base text-gray-500 font-normal underline leading-6.5')}>Justnote.cc</Text> to take the action.</Text>
      </View>
      <View style={tailwind('mt-8')}>
        <Text style={tailwind('text-base text-gray-800 font-medium leading-5')}>Export All Data</Text>
        <Text style={tailwind('mt-2.5 text-base text-gray-500 font-normal leading-6.5')}>Export all your data from server to your device in a zip file. Please go to <Text onPress={() => Linking.openURL(DOMAIN_NAME)} style={tailwind('text-base text-gray-500 font-normal underline leading-6.5')}>Justnote.cc</Text> to take the action.</Text>
      </View>
