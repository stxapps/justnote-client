  ...
  return (
    <View style={tailwind('p-4 md:p-6')}>
      ...
      <View style={tailwind('mt-6 md:mt-0')}>
        ...
        <Text style={tailwind('mt-2.5 text-base font-normal leading-6.5 text-gray-500 blk:text-gray-400')}>Justnote stores your data in a Stacks data server. You can specify which Stacks data server to store your data. By default, your Stacks data server is at <Text onPress={() => Linking.openURL('https://hub.blockstack.org/hub_info')} style={tailwind('text-base font-normal leading-6.5 text-gray-500 underline blk:text-gray-400')}>hub.blockstack.org</Text> provided by <Text onPress={() => Linking.openURL('https://www.hiro.so')} style={tailwind('text-base font-normal leading-6.5 text-gray-500 underline blk:text-gray-400')}>Hiro Systems</Text>. You can also deploy your own Stacks data server. To change your Stacks data server, you need to record your server’s information on the Stacks blockchain. Justnote stores your data on the server specified in the blockchain. For more details, please visit <Text onPress={() => Linking.openURL('https://docs.stacks.co/docs/gaia')} style={tailwind('text-base font-normal leading-6.5 text-gray-500 underline blk:text-gray-400')}>Stacks Gaia</Text>.</Text>
      </View>
      <View style={tailwind('mt-8')}>
        <Text style={tailwind('text-base font-medium leading-5 text-gray-800 blk:text-gray-100')}>Import Data</Text>
        <Text style={tailwind('mt-2.5 text-base font-normal leading-6.5 text-gray-500 blk:text-gray-400')}>Import data from a zip file. Please go to <Text onPress={() => Linking.openURL(DOMAIN_NAME)} style={tailwind('text-base font-normal leading-6.5 text-gray-500 underline blk:text-gray-400')}>Justnote.cc</Text> to take the action.</Text>
      </View>
      <View style={tailwind('mt-8')}>
        <Text style={tailwind('text-base font-medium leading-5 text-gray-800 blk:text-gray-100')}>Export All Data</Text>
        <Text style={tailwind('mt-2.5 text-base font-normal leading-6.5 text-gray-500 blk:text-gray-400')}>Export all your data from the server to your device in a zip file. Please go to <Text onPress={() => Linking.openURL(DOMAIN_NAME)} style={tailwind('text-base font-normal leading-6.5 text-gray-500 underline blk:text-gray-400')}>Justnote.cc</Text> to take the action.</Text>
      </View>
