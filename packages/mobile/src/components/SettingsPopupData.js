  ...
  return (
    <View style={tailwind('p-4 md:p-6 md:pt-4', safeAreaWidth)}>
      ...
      <View style={tailwind('mt-8')}>
        ...
        <Text style={tailwind('mt-2.5 text-base text-gray-500 font-normal leading-6.5')}>Export all your data from server to your device in a text file. Please go to <Text onPress={() => Linking.openURL('https://justnote.cc')} style={tailwind('text-base text-gray-500 font-normal underline')}>Justnote.cc</Text> to take the action.</Text>
      </View>
  ...
  if (!exportAllDataProgress) {
    actionPanel = (
      <View style={tailwind('mt-6 mb-4 justify-start items-start')}>
        <TouchableOpacity onPress={onExportAllDataBtnClick} style={tailwind('px-4 py-2 border border-gray-300 rounded-md bg-white shadow-sm')}>
    ...
    actionPanel = (
      <View style={tailwind('mt-6 mb-4')}>
        <View style={tailwind('flex-row items-center')}>
          <Svg style={tailwind('text-base text-red-500 font-normal')} width={20} height={20} viewBox="0 0 20 20" fill="currentColor">
        ...
        <Text style={tailwind('mt-6 text-base text-gray-500 font-normal leading-6.5')}>Please wait a moment and try again. If the problem persists, please <Text onPress={() => Linking.openURL('https://justnote.cc/support')} style={tailwind('text-base text-gray-500 font-normal underline')}>contact us</Text>
          <Svg style={tailwind('mb-2 text-base text-gray-500 font-normal')} width={16} height={16} viewBox="0 0 20 20" fill="currentColor">
    ...
    actionPanel = (
      <View style={tailwind('mt-6 mb-4')}>
        <View style={tailwind('flex-row items-center')}>
          <Svg style={tailwind('text-base text-gray-400 font-normal')} width={20} height={20} viewBox="0 0 20 20" fill="currentColor">
...
const _SettingsPopupDataDelete = (props) => {
  ...
  if (!deleteAllDataProgress) {
    actionPanel = (
      <View style={tailwind('mt-6 mb-4 justify-start items-start')}>
        <TouchableOpacity onPress={onDeleteAllDataBtnClick} style={tailwind('px-4 py-2 rounded-md bg-red-500 shadow-sm')}>
          <Text style={tailwind('text-sm text-white font-normal')}>Delete All My Data</Text>
        </TouchableOpacity>
