  ...
  return (
    <View style={tailwind('p-4 md:p-6')}>
      ...
      <View style={tailwind('mt-8')}>
        ...
        <Text style={tailwind('mt-2.5 text-base font-normal leading-6.5 text-gray-500 blk:text-gray-400')}>Export all your data from server to your device in a zip file. Please go to <Text onPress={() => Linking.openURL(DOMAIN_NAME)} style={tailwind('text-base font-normal leading-6.5 text-gray-500 underline blk:text-gray-400')}>Justnote.cc</Text> to take the action.</Text>
      </View>
