  ...
  return (
    <View style={tailwind('p-4 md:p-6')}>
      <View style={tailwind('border-b border-gray-200 md:hidden')}>
        ...
        <Text style={tailwind('pb-2 text-xl font-medium leading-6 text-gray-800')}>Data</Text>
      </View>
      <View style={tailwind('mt-6 md:mt-0')}>
        <Text style={tailwind('text-base font-medium leading-5 text-gray-800')}>Data Server</Text>
        <Text style={tailwind('mt-2.5 text-base font-normal text-gray-500 leading-6.5')}>Justnote stores your data in a Stacks data server. You can specify which Stacks data server to store your data. By default, your Stacks data server is at <Text onPress={() => Linking.openURL('https://hub.blockstack.org/hub_info')} style={tailwind('text-base font-normal text-gray-500 underline leading-6.5')}>hub.blockstack.org</Text> provided by <Text onPress={() => Linking.openURL('https://www.hiro.so')} style={tailwind('text-base font-normal text-gray-500 underline leading-6.5')}>Hiro Systems</Text>. You can also deploy your own Stacks data server. To change your Stacks data server, you need to record your server’s information to Stacks blockchain. Justnote stores your data to the server specified in the blockchain. For more details, please visit <Text onPress={() => Linking.openURL('https://docs.stacks.co/docs/gaia')} style={tailwind('text-base font-normal text-gray-500 underline leading-6.5')}>Stacks Gaia</Text>.</Text>
      </View>
      <View style={tailwind('mt-8')}>
        <Text style={tailwind('text-base font-medium leading-5 text-gray-800')}>Import Data</Text>
        <Text style={tailwind('mt-2.5 text-base font-normal text-gray-500 leading-6.5')}>Import data from a zip file. Please go to <Text onPress={() => Linking.openURL(DOMAIN_NAME)} style={tailwind('text-base font-normal text-gray-500 underline leading-6.5')}>Justnote.cc</Text> to take the action.</Text>
      </View>
      <View style={tailwind('mt-8')}>
        <Text style={tailwind('text-base font-medium leading-5 text-gray-800')}>Export All Data</Text>
        <Text style={tailwind('mt-2.5 text-base font-normal text-gray-500 leading-6.5')}>Export all your data from server to your device in a zip file. Please go to <Text onPress={() => Linking.openURL(DOMAIN_NAME)} style={tailwind('text-base font-normal text-gray-500 underline leading-6.5')}>Justnote.cc</Text> to take the action.</Text>
      </View>
      <View style={tailwind('mt-8 mb-4')}>
        <TouchableOpacity onPress={onToDeleteAllDataViewBtnClick}>
          <Text style={tailwind('text-base font-medium leading-5 text-gray-800 underline')}>Delete All Data</Text>
        </TouchableOpacity>
        <Text style={tailwind('mt-2.5 text-base font-normal text-gray-500 leading-6.5')}>Delete all your data including but not limited to all your saved notes in all lists, all your created lists, and all your settings.</Text>
      </View>
    </View>
  );
};
  ...
  if (!deleteAllDataProgress) {
    actionPanel = (
      <View style={tailwind('mt-6 mb-4 items-start justify-start')}>
        <TouchableOpacity onPress={onDeleteAllDataBtnClick} style={tailwind('rounded-md border border-gray-300 bg-white px-2 py-2 shadow-sm')}>
          <Text style={tailwind('text-sm font-normal text-gray-500')}>Delete All My Data</Text>
        </TouchableOpacity>
        {isRequiredConfirmShown && <Text style={tailwind('mt-2 text-base font-normal text-red-600')}>Please confirm by checking the box above first.</Text>}
      </View>
    );
    ...
    actionPanel = (
      <View style={tailwind('mt-6 mb-4')}>
        ...
        <Text style={tailwind('mt-6 text-base font-normal text-gray-500 leading-6.5')}>Please wait a moment and try again. If the problem persists, please <Text onPress={() => Linking.openURL(DOMAIN_NAME + '/' + HASH_SUPPORT)} style={tailwind('text-base font-normal text-gray-500 underline')}>contact us</Text>
  ...
  return (
    <View style={tailwind('p-4 md:p-6 md:pt-4')}>
      <View style={tailwind('border-b border-gray-200 md:border-b-0')}>
        ...
        <Text style={tailwind('pb-2 text-xl font-medium leading-6 text-gray-800 md:pb-0')}>Delete All Data</Text>
      </View>
      <Text style={tailwind('mt-6 text-base font-normal text-gray-500 leading-6.5')}>Delete all your data including but not limited to all your saved notes in all lists, all your created lists, and all your settings.</Text>
      ...
      <Text style={tailwind('mt-6 text-base font-normal text-red-500 leading-6.5')}>This action CANNOT be undone.</Text>
      <View style={tailwind('mt-6 flex-row items-center')}>
        ...
        <Text style={tailwind('ml-2 flex-shrink flex-grow text-base font-normal text-gray-500')}>Yes, I’m absolutely sure I want to delete all my data.</Text>
      </View>
      {actionPanel}
    </View>
  );
