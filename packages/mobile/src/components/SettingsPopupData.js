  ...
  return (
    <View style={tailwind('p-4 md:p-6')}>
      ...
      <View style={tailwind('mt-8')}>
        ...
        <Text style={tailwind('mt-2.5 text-base font-normal leading-6.5 text-gray-500 blk:text-gray-400')}>Import data from a zip file. The zip file can be exported from some note taking apps i.e. <Text onPress={() => Linking.openURL('https://takeout.google.com/')} style={tailwind('text-base font-normal leading-6.5 text-gray-500 underline blk:text-gray-400')}>Google Keep</Text>, <Text onPress={() => Linking.openURL('https://help.evernote.com/hc/en-us/articles/209005557-Export-notes-and-notebooks-as-ENEX-or-HTML')} style={tailwind('text-base font-normal leading-6.5 text-gray-500 underline blk:text-gray-400')}>Evernote</Text> (as multiple web pages (.html) and manually zip the folder), and our website.</Text>
      </View>
      <View style={tailwind('mt-8')}>
