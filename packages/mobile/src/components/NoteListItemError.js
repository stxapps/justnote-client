...
const NoteListItemError = (props) => {
  ...
  return (
    <TouchableOpacity activeOpacity={1.0} onPress={onContentBtnClick} style={tailwind('w-full rounded-sm flex-row items-center px-3 py-4 sm:px-5', safeAreaWidth)}>
      <View style={tailwind('w-10 h-10 bg-red-50 border border-red-100 mr-3 rounded-full items-center justify-center')}>
        <Svg style={tailwind('w-5 h-5 text-red-400 font-normal')} viewBox="0 0 20 20" fill="currentColor">
