      ...
      <ScrollView horizontal={true}>
        <View style={[tailwind('h-full flex-row justify-between sm:px-6 lg:px-8 lg:items-center', safeAreaWidth), style]}>
          <View style={tailwind('flex-row')}>
            ...
            <TouchableOpacity onPress={onToggleFullScreen} style={tailwind('hidden px-4 py-2 border border-gray-300 shadow-sm rounded-md bg-white lg:flex lg:flex-row', safeAreaWidth)}>
