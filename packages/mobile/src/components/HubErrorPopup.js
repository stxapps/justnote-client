        ...
        <View style={tailwind('m-4 rounded-md bg-red-50 p-4 shadow-lg')}>
          <View style={tailwind('flex-row')}>
            ...
            <View style={tailwind('ml-3 flex-shrink flex-grow lg:mt-0.5')}>
              ...
              <Text style={tailwind('mt-2.5 text-sm font-normal leading-6 text-red-700')}>Hiro-hosted data server is discontinued. {safeAreaWidth < SM_WIDTH ? '' : '\n'}Please migrate your data now. For more information: <Text onPress={() => Linking.openURL('http://bit.ly/3Sv6ebK')} style={tailwind('text-sm font-normal leading-6 text-red-700 underline')}>http://bit.ly/3Sv6ebK</Text></Text>
            </View>
          </View>
