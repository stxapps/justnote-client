  ...
  return (
    <View style={tailwind('p-4 md:p-6')}>
      <View style={tailwind('border-b border-gray-200 md:hidden')}>
        ...
        <Text style={tailwind('pb-2 text-xl font-medium leading-6 text-gray-800')}>Account</Text>
      </View>
      <View style={tailwind('mt-6 md:mt-0')}>
        <Text style={tailwind('text-base font-medium leading-5 text-gray-800')}>Stacks Account</Text>
      ...
      <View style={tailwind('mt-8 mb-4')}>
        <Text style={tailwind('text-base font-medium leading-5 text-red-600')}>Delete Account</Text>
