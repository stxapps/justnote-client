  ...
  return (
    <View style={tailwind('p-4 md:p-6')}>
      ...
      <View style={tailwind('mt-8 mb-4')}>
        <Text style={tailwind('text-base font-medium leading-5 text-red-600 blk:text-red-500')}>Delete Account</Text>
