    ...
    <View style={tailwind('p-4 md:p-6')}>
      ...
      <View style={tailwind('mt-5 md:mt-0')}>
        <View style={tailwind('hidden md:flex')}>
          <SvgXml width={28} height={28} xml={themeMode === BLK_MODE ? shortLogoBlk : shortLogo} />
        </View>
      ...
      <View style={tailwind('flex-row items-center justify-start pt-14')}>
        <TouchableOpacity onPress={() => Linking.openURL('https://twitter.com/justnotecc')} style={tailwind('my-0.5')}>
