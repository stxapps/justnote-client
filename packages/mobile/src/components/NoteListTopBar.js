...
const NoteListTopBar = (props) => {
  ...
  const menuBtnSvg = (
    <View style={tailwind('justify-center items-center w-10 rounded-full')}>
      <Svg width={24} height={24} style={tailwind('text-gray-500 font-normal')} viewBox="0 0 20 20" fill="currentColor">
    ...
    innerMenuBtn = (
      <React.Fragment>
        ...
        <Animated.View style={[tailwind('absolute top-0 left-0 h-full justify-center'), innerMenuBtnStyle]}>
          <Svg width={40} height={40} style={tailwind('text-green-600 font-normal')} viewBox="0 0 100 100" fill="none" stroke="currentColor" preserveAspectRatio="xMidYMid">
  ...
  return (
    <View style={tailwind('flex-grow-0 flex-shrink-0')}>
      <View style={tailwind('h-16 border-b border-gray-200 flex-row items-center justify-between')}>
        ...
        <View style={tailwind('pl-4 flex-1 flex-row items-center justify-between sm:pl-6', safeAreaWidth)}>
          ...
          <View style={tailwind('ml-4 flex-row')}>
            <TouchableOpacity onPress={onSearchBtnClick} style={tailwind('items-center justify-center px-1 border border-white bg-white lg:hidden', safeAreaWidth)}>
              <View style={tailwind('p-2.5 rounded')}>
            ...
            <TouchableOpacity ref={menuBtn} onPress={onMenuBtnClick} style={tailwind('items-center justify-center pr-2 border border-white h-10 bg-white')}>
              {innerMenuBtn}
            </TouchableOpacity>
          </View>
        </View>
