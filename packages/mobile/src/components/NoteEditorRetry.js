    ...
    <View style={tailwind('w-full h-full bg-white')}>
      <ScrollView>
        <View style={[tailwind('px-4 pb-4 sm:px-6 sm:pb-6', safeAreaWidth), style]}>
          ...
          <Text style={tailwind('text-gray-500 text-sm font-normal')}>Please wait a moment and try again. If the problem persists, please <Text onPress={() => Linking.openURL('https://justnote.cc/' + HASH_SUPPORT)} style={tailwind('text-gray-500 text-sm font-normal underline')}>contact us</Text>
            <Svg width={16} height={16} style={tailwind('mb-2 text-gray-500 font-normal')} viewBox="0 0 20 20" fill="currentColor">
          ...
          <View style={tailwind('pt-6 flex-row items-center')}>
            <TouchableOpacity onPress={onRetryRetryBtnClick} style={tailwind('flex-row items-center px-4 py-2 border border-gray-300 shadow-sm rounded-md bg-white')}>
            ...
            <TouchableOpacity onPress={onRetryCancelBtnClick} style={tailwind('ml-2 px-2 py-1.5 rounded-md border border-white bg-white')}>
              <Text style={tailwind('text-sm text-gray-500 font-normal')}>Cancel</Text>
            </TouchableOpacity>
          </View>
          <View style={tailwind('mt-6 border border-gray-200 rounded-lg px-4 py-5')}>
