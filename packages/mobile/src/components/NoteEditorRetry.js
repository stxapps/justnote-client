        ...
        <View style={[tailwind('px-4 pb-4 sm:px-6 sm:pb-6', safeAreaWidth), style]}>
          ...
          <View style={tailwind('pt-6 flex-row items-center')}>
            <TouchableOpacity onPress={onRetryRetryBtnClick} style={tailwind('flex-row items-center px-4 py-2 border border-gray-300 shadow-sm rounded-md bg-white')}>
              ...
              <Text style={tailwind('text-sm text-gray-600 font-normal')}>Retry</Text>
            </TouchableOpacity>
            <TouchableOpacity onPress={onRetryCancelBtnClick} style={tailwind('ml-2 mt-1 px-3 py-1 rounded-md border border-white bg-white')}>
              <Text style={tailwind('text-sm text-gray-600 font-normal')}>Cancel</Text>
            </TouchableOpacity>
          </View>
