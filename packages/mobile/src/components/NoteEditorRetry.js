    ...
    <View style={tailwind('h-full w-full bg-white')}>
      <ScrollView>
        <View style={[tailwind('px-4 pb-4 sm:px-6 sm:pb-6'), style]}>
          ...
          <Text style={tailwind('pt-5 text-lg font-medium text-gray-800')}>Problem found</Text>
          <Text style={tailwind('text-sm font-normal text-gray-500')}>Please wait a moment and try again. If the problem persists, please <Text onPress={() => Linking.openURL(DOMAIN_NAME + '/' + HASH_SUPPORT)} style={tailwind('text-sm font-normal text-gray-500 underline')}>contact us</Text>
            <Svg width={16} height={16} style={tailwind('mb-2 font-normal text-gray-500')} viewBox="0 0 20 20" fill="currentColor">
          ...
          <View style={tailwind('flex-row items-center pt-6')}>
            <TouchableOpacity onPress={onRetryRetryBtnClick} style={tailwind('flex-row items-center rounded-md border border-gray-300 bg-white px-4 py-2 shadow-sm')}>
              ...
              <Text style={tailwind('text-sm font-normal text-gray-500')}>Retry</Text>
            </TouchableOpacity>
            <TouchableOpacity onPress={onRetryCancelBtnClick} style={tailwind('ml-2 rounded-md border border-white bg-white px-2 py-1.5')}>
              <Text style={tailwind('text-sm font-normal text-gray-500')}>Cancel</Text>
            </TouchableOpacity>
          </View>
          <View style={tailwind('mt-6 rounded-lg border border-gray-200 px-4 py-5')}>
          ...
          <View style={tailwind('absolute top-0 left-0 lg:hidden')}>
            <TouchableOpacity onPress={onRightPanelCloseBtnClick} style={tailwind('rounded-md bg-white px-4 py-4')}>
