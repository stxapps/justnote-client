    ...
    <View style={tailwind('w-full h-full bg-white')}>
      <ScrollView>
        <View style={[tailwind('px-4 pb-4 sm:px-6 sm:pb-6', safeAreaWidth), style]}>
          ...
          <Text style={tailwind('text-gray-500 text-sm font-normal')}>Please wait a moment and try again. If the problem persists, please <Text onPress={() => Linking.openURL(DOMAIN_NAME + '/' + HASH_SUPPORT)} style={tailwind('text-gray-500 text-sm font-normal underline')}>contact us</Text>
