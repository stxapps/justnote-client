  ...
  return (
    <View style={tailwind('flex-grow-0 flex-shrink-0 border-b border-gray-200 w-full h-16')}>
      <View style={tailwind('w-full h-full flex-row justify-between sm:pl-3 sm:pr-6', safeAreaWidth)}>
        ...
        <View style={tailwind('flex-1 h-full flex-row items-center justify-between sm:pl-2', safeAreaWidth)}>
          ...
          <View style={tailwind('pl-4 flex-shrink-0 flex-grow-0 h-full flex-row')}>
            <NoteCommands />
          </View>
        </View>
      </View>
