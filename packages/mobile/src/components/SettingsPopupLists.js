  ...
  return (
    <View style={tailwind('p-4 md:p-6')}>
      <View style={tailwind('border-b border-gray-200 md:hidden')}>
        ...
        <Text style={tailwind('pb-2 text-xl font-medium leading-6 text-gray-800')}>Lists</Text>
      </View>
      <View style={tailwind('hidden md:flex')}>
        <Text style={tailwind('text-base font-medium leading-5 text-gray-800')}>Lists</Text>
      </View>
