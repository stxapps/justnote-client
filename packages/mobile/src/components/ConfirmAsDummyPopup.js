      ...
      <Animated.View style={[tailwind('w-full max-w-lg rounded-lg bg-white px-4 pt-5 pb-4 shadow-xl sm:my-8 sm:p-6'), popupStyle]}>
        <View style={tailwind('items-center sm:flex-row sm:items-start')}>
          ...
          <View style={tailwind('mt-3 flex-shrink flex-grow sm:mt-0 sm:ml-4')}>
            <Text style={tailwind('text-center text-lg font-medium leading-6 text-gray-900 sm:text-left')}>Confirm continue?</Text>
            <View style={tailwind('mt-2')}>
              <Text style={tailwind('text-center text-sm font-normal text-gray-500 sm:text-left')}>Without an account, your notes cannot be encrypted and synced to server. If you lose your device or accidentally uninstall the app, you'll lose your notes forever.</Text>
            </View>
          </View>
        </View>
        <View style={tailwind('mt-5 sm:mt-4 sm:ml-10 sm:flex-row sm:pl-4')}>
          <TouchableOpacity onPress={onOkBtnClick} style={tailwind('w-full rounded-md border border-red-600 bg-red-600 px-4 py-2 shadow-sm sm:w-auto')}>
            <Text style={tailwind('text-center text-base font-medium text-white sm:text-sm')}>I understand</Text>
          </TouchableOpacity>
