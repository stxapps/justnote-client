  ...
  return (
    <View style={tailwind('w-full h-full')}>
      <ScrollView horizontal={true}>
        <View style={[tailwind('px-4 h-full bg-gray-600 sm:px-6', safeAreaWidth), style]}>
          ...
          <TouchableOpacity onPress={onExitBtnClick} style={tailwind('absolute top-4 right-4 p-3 rounded')}>
            <Svg width={16} height={16} style={tailwind('text-white font-normal')} viewBox="0 0 20 20" fill="currentColor">
