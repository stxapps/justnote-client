  ...
  return (
    <View style={tailwind('h-full w-full')}>
      <ScrollView horizontal={true}>
        <View style={[tailwind('h-full bg-gray-600 px-4 sm:px-6'), style]}>
          ...
          <TouchableOpacity onPress={onExitBtnClick} style={tailwind('absolute top-4 right-4 rounded p-3')}>
            <Svg width={16} height={16} style={tailwind('font-normal text-white')} viewBox="0 0 20 20" fill="currentColor">
