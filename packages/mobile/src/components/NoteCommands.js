...
const NoteCommands = (props) => {
  ...
  return (
    <React.Fragment>
      {isArchiveBtnShown && <TouchableOpacity onPress={onArchiveBtnClick} style={[tailwind(`h-full flex-row items-center border pl-1 pr-1 sm:pl-2 lg:rounded-md lg:px-2 lg:py-2 lg:shadow-sm ${btnClassNames}`), { maxWidth: 128 }]}>
      ...
      {isRemoveBtnShown && <TouchableOpacity onPress={onRemoveBtnClick} style={tailwind(`h-full flex-row items-center border pl-1 pr-1 sm:pl-2 lg:rounded-md lg:px-2 lg:py-2 lg:shadow-sm ${btnClassNames}`)}>
      ...
      {isRestoreBtnShown && <TouchableOpacity onPress={onRestoreBtnClick} style={tailwind(`h-full flex-row items-center border pl-1 pr-1 sm:pl-2 lg:rounded-md lg:px-2 lg:py-2 lg:shadow-sm ${btnClassNames}`)}>
        <View style={tailwind('rounded p-2 lg:p-0')}>
          <Svg width={20} height={20} style={tailwind(`font-normal ${textClassNames}`)} viewBox="0 0 20 20" fill="currentColor">
      ...
      {isDeleteBtnShown && <TouchableOpacity onPress={onDeleteBtnClick} style={tailwind(`h-full flex-row items-center border pl-1 pr-1 sm:pl-2 lg:rounded-md lg:px-2 lg:py-2 lg:shadow-sm ${btnClassNames}`)}>
        <View style={tailwind('rounded p-2 lg:p-0')}>
      ...
      {isMoveToBtnShown && <TouchableOpacity ref={moveToBtn} onPress={onMoveToBtnClick} style={tailwind(`h-full flex-row items-center border pl-1 pr-1 sm:pl-2 lg:rounded-md lg:px-2 lg:py-2 lg:shadow-sm ${btnClassNames}`)}>
        <View style={tailwind('rounded p-2 lg:p-0')}>
          <Svg width={20} height={20} style={tailwind(`font-normal ${textClassNames}`)} viewBox="0 0 20 20" fill="currentColor">
