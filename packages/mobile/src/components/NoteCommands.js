  ...
  return (
    <React.Fragment>
      {isArchiveBtnShown && <TouchableOpacity onPress={onArchiveBtnClick} style={[tailwind(`flex-row items-center h-full pl-1 pr-1 border border-white bg-white sm:pl-2 lg:px-2 lg:py-2 lg:border-gray-300 lg:rounded-md lg:shadow-sm ${btnClassNames}`, safeAreaWidth), { maxWidth: 128 }]}>
        <View style={tailwind('p-2 rounded lg:p-0 lg:flex-shrink-0 lg:flex-grow-0', safeAreaWidth)}>
        ...
        <Text style={tailwind(`hidden text-sm font-normal lg:ml-1 lg:flex lg:flex-shrink lg:flex-grow ${textClassNames}`, safeAreaWidth)} numberOfLines={1} ellipsizeMode="tail">{getListNameDisplayName(ARCHIVE, listNameMap)}</Text>
      </TouchableOpacity>}
      ...
      {isRestoreBtnShown && <TouchableOpacity onPress={onRestoreBtnClick} style={tailwind(`flex-row items-center h-full pl-1 pr-1 border border-white bg-white sm:pl-2 lg:px-2 lg:py-2 lg:border-gray-300 lg:rounded-md lg:shadow-sm ${btnClassNames}`, safeAreaWidth)}>
        <View style={tailwind('p-2 rounded lg:p-0', safeAreaWidth)}>
          <Svg width={20} height={20} style={tailwind(`font-normal ${textClassNames}`)} viewBox="0 0 20 20" fill="currentColor">
      ...
      {isDeleteBtnShown && <TouchableOpacity onPress={onDeleteBtnClick} style={tailwind(`flex-row items-center h-full pl-1 pr-1 border border-white bg-white sm:pl-2 lg:px-2 lg:py-2 lg:border-gray-300 lg:rounded-md lg:shadow-sm ${btnClassNames}`, safeAreaWidth)}>
        <View style={tailwind('p-2 rounded lg:p-0', safeAreaWidth)}>
      ...
      {isMoveToBtnShown && <TouchableOpacity ref={moveToBtn} onPress={onMoveToBtnClick} style={tailwind(`flex-row items-center h-full pl-1 pr-1 border border-white bg-white sm:pl-2 lg:px-2 lg:py-2 lg:border-gray-300 lg:rounded-md lg:shadow-sm ${btnClassNames}`, safeAreaWidth)}>
        <View style={tailwind('p-2 rounded lg:p-0', safeAreaWidth)}>
          <Svg width={20} height={20} style={tailwind(`font-normal ${textClassNames}`)} viewBox="0 0 20 20" fill="currentColor">
