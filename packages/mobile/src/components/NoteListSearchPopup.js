...
const NoteListSearchPopup = () => {
  ...
  return (
    <Animated.View style={[tailwind('h-14 flex-row items-center justify-between border-b border-gray-200 pl-4 pr-2 sm:pl-6 sm:pr-4 lg:hidden'), popupStyle]}>
      <View style={tailwind('flex-1 rounded-md bg-white shadow-sm')}>
        ...
        <TextInput ref={searchInput} onChange={onSearchInputChange} style={tailwind('w-full rounded-md border border-gray-300 py-1.5 pl-9 pr-6 text-base font-normal leading-5 text-gray-700')} placeholder="Search" placeholderTextColor="rgba(113, 128, 150, 1)" value={searchString} autoCapitalize="none" />
