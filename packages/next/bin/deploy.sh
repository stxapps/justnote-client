...
readonly cachedItems=(
    ...
    "ss-mobile-3.png" "ss-mobile-4.png" "ss-mobile-5.png" "ss-mobile-6.png"
    "ss-mobile-7.png" "ss-wide-1.png" "ss-wide-2.png" "ss-wide-3.png"
    "ss-wide-4.png" "ss-wide-5.png" "ss-wide-6.png" "ss-wide-7.png"
    "twitter-card-image-pattern1.png"
)
...
aws s3 cp "${SOURCE_DIR}/service-worker.js" "${S3_BUCKET}/service-worker.js" --acl public-read --cache-control "${CACHE_REVALIDATE}" --profile justnote
aws s3 cp "${SOURCE_DIR}/sw.js" "${S3_BUCKET}/sw.js" --acl public-read --cache-control "${CACHE_REVALIDATE}" --profile justnote
...
aws cloudfront create-invalidation --distribution-id "${CLOUDFRONT_DISTRIBUTION_ID}" --paths "/*" --profile justnote
