        ...
        <main className="sm:flex">
          ...
          <div className="sm:ml-6">
            <div className="sm:border-l sm:border-gray-200 sm:pl-6">
              ...
              <div className="mt-6">
                <button onClick={() => reset()} className="rounded-full bg-red-600 px-4 py-2 text-sm font-medium text-white shadow-xs hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-600 focus:ring-offset-2">Try again</button>
              </div>
            </div>
          </div>
        </main>
