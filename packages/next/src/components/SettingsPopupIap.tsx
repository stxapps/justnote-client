...
const IapHome = (props) => {
    ...
    if (purchaseStatus === null) {
      ...
      actionPanel = (
        <div className={tailwind('mt-6')}>
          ...
          <p className={tailwind('mt-6 text-base leading-relaxed text-gray-500 blk:text-gray-400')}>Please wait a moment and <button onClick={onRetryVerifyPurchaseBtnClick} className={tailwind('rounded underline hover:text-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-400 blk:hover:text-gray-200 blk:focus:ring-gray-500')}>try again</button>.</p>
      ...
      actionPanel = (
        <div className={tailwind('mt-6')}>
          ...
          <p className={tailwind('mt-6 text-base leading-relaxed text-gray-500 blk:text-gray-400')}>Please wait a moment and <button onClick={onRetryRequestPurchaseBtnClick} className={tailwind('rounded underline hover:text-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-400 blk:hover:text-gray-200 blk:focus:ring-gray-500')}>try again</button>.</p>
    ...
    if (productStatus === GET_PRODUCTS_ROLLBACK) {
      actionPanel = (
        <div className={tailwind('mt-6')}>
          ...
          <p className={tailwind('mt-6 text-base leading-relaxed text-gray-500 blk:text-gray-400')}>Please wait a moment and <button onClick={onRetryGetProductsBtnClick} className={tailwind('rounded underline hover:text-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-400 blk:hover:text-gray-200 blk:focus:ring-gray-500')}>try again</button>.</p>
          <p className={tailwind('mt-6 text-base leading-relaxed text-gray-500 blk:text-gray-400')}>If the problem persists, please <a className={tailwind('rounded underline hover:text-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-400 blk:hover:text-gray-200 blk:focus:ring-gray-500')} href={'/' + HASH_SUPPORT} target="_blank" rel="noreferrer">contact us</a>.</p>
        </div>
      );
    } else {
  ...
  return (
    <div className={tailwind('mt-6 mb-4 md:mt-0')}>
      ...
      <p className={tailwind('mt-4 text-base leading-relaxed text-gray-500 blk:text-gray-400')}>Please support us and unlock extra features:</p>
      <div className={tailwind('pt-3 lg:flex lg:justify-between lg:pt-5')}>
        ...
        <div className={tailwind('flex pt-2 lg:w-48 lg:pt-0')}>
          ...
          <span className={tailwind('ml-3 font-medium text-gray-500 blk:text-gray-400')}>Lock lists & notes</span>
        </div>
        <div className={tailwind('flex pt-2 lg:w-44 lg:pt-0')}>
          <svg className={tailwind('h-6 w-5 flex-none text-green-600 blk:text-green-400')} viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
            <path fillRule="evenodd" d="M16.704 4.153a.75.75 0 01.143 1.052l-8 10.5a.75.75 0 01-1.127.075l-4.5-4.5a.75.75 0 011.06-1.06l3.894 3.893 7.48-9.817a.75.75 0 011.05-.143z" clipRule="evenodd"></path>
          </svg>
          <span className={tailwind('ml-3 font-medium text-gray-500 blk:text-gray-400')}>More font sizes</span>
        </div>
      </div>
      <div className={tailwind('lg:flex lg:justify-between lg:pt-5')}>
        ...
        <div className={tailwind('flex pt-2 lg:w-48 lg:pt-0')}>
          ...
          <span className={tailwind('ml-3 font-medium text-gray-500 blk:text-gray-400')}>Custom date format</span>
        </div>
        <div className={tailwind('flex pt-2 lg:w-44 lg:pt-0')}>
          <svg className={tailwind('h-6 w-5 flex-none text-green-600 blk:text-green-400')} viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
            <path fillRule="evenodd" d="M16.704 4.153a.75.75 0 01.143 1.052l-8 10.5a.75.75 0 01-1.127.075l-4.5-4.5a.75.75 0 011.06-1.06l3.894 3.893 7.48-9.817a.75.75 0 011.05-.143z" clipRule="evenodd"></path>
          </svg>
          <span className={tailwind('ml-3 font-medium text-gray-500 blk:text-gray-400')}>Section by month</span>
        </div>
      </div>
      ...
      {actionPanel}
      <p className={tailwind('mt-6 text-sm leading-relaxed text-gray-400 blk:text-gray-500')}>By subscribing, you agree to our <a className={tailwind('rounded text-gray-500 underline hover:text-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-400 blk:text-gray-400 blk:hover:text-gray-200 blk:focus:ring-gray-500')} href={'/' + HASH_TERMS} target="_blank" rel="noreferrer">Terms of Service</a> and <a className={tailwind('rounded text-gray-500 underline hover:text-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-400 blk:text-gray-400 blk:hover:text-gray-200 blk:focus:ring-gray-500')} href={'/' + HASH_PRIVACY} target="_blank" rel="noreferrer">Privacy Policy</a>. Only one free trial per user; the payment processing service&apos;s Terms and Conditions apply.</p>
...
const IapPurchased = (props) => {
  ...
  if (purchase.source === APPSTORE) {
    ...
    if (purchase.status === NO_RENEW) {
      appStoreLink = (
        <a className={tailwind('rounded underline hover:text-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-400 blk:hover:text-gray-200 blk:focus:ring-gray-500')} href="https://paddle.net/" target="_blank" rel="noreferrer">Paddle</a>
      );
    } else {
      ...
      appStoreLink = (
        <a className={tailwind('rounded underline hover:text-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-400 blk:hover:text-gray-200 blk:focus:ring-gray-500')} href={link} target="_blank" rel="noreferrer">Paddle</a>
      );
    }
  }
  ...
  if (purchase.status === ACTIVE) {
    infoText = (
      <React.Fragment>
        <p className={tailwind('mt-4 text-base leading-relaxed text-gray-500 blk:text-gray-400')}>
          ...
          <span className={tailwind('text-green-600 blk:text-green-500')}>Thank you very much for supporting us.</span> You&apos;ve unlocked extra features: tags, lock lists & notes, more font sizes, dark appearance, custom date format, section by month, and pin to the top.
        </p>
    ...
    infoText = (
      <React.Fragment>
        <p className={tailwind('mt-4 text-base leading-relaxed text-gray-500 blk:text-gray-400')}>Thank you very much for supporting us. You&apos;ve unlocked extra features: tags, lock lists & notes, more font sizes, dark appearance, custom date format, section by month, and pin to the top.</p>
...
const InnerSettingsPopupIapRestore = (props) => {
  ...
  if (restoreStatus === null) {
    actionPanel = (
      <button onClick={onRestoreBtnClick} type="button" className={tailwind('mt-7 mb-4 block rounded-md border border-gray-300 bg-white px-2 py-2 text-sm text-gray-500 shadow-xs hover:border-gray-400 hover:text-gray-600 focus:border-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2 blk:border-gray-400 blk:bg-gray-900 blk:text-gray-300 blk:hover:border-gray-300 blk:hover:text-gray-200 blk:focus:border-gray-300 blk:focus:ring-gray-500 blk:focus:ring-offset-gray-900')}>
    ...
    <div className={tailwind('p-4 md:p-6 md:pt-4')}>
      <div className={tailwind('border-b border-gray-200 blk:border-gray-700 md:border-b-0')}>
        <button onClick={onBackToIapViewBtnClick} className={tailwind('group pb-1 focus:outline-none md:pb-0')}>
          <span className={tailwind('rounded text-sm text-gray-500 group-focus:ring-2 group-focus:ring-gray-400 blk:text-gray-400 blk:group-focus:ring-gray-500')}>{'<'} <span className={tailwind('group-hover:underline')}>{safeAreaWidth < toPx(MD_WIDTH) ? 'Settings / ' : ''}Subscription</span></span>
        </button>
