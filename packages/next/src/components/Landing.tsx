    ...
    <React.Fragment>
        ...
        <div className={tailwind('relative overflow-hidden')}>
          ...
          <div className={tailwind('relative')}>
            ...
            <div className={tailwind('relative mx-auto max-w-4xl px-4 sm:px-6')}>
              ...
              <img className={tailwind('mx-auto rounded-lg shadow-lg')} src="/images/main-desktop-in-dark-chrome.97c7f9b4e723a4cea91e.png" srcSet="/images/main-desktop-in-dark-chrome.97c7f9b4e723a4cea91e.png 1x, /images/main-desktop-in-dark-chrome@2x.2680806c7ba525189099.png 2x, /images/main-desktop-in-dark-chrome@3x.a7c1d62c03c69d6d5b13.png 3x" alt="App screenshot" />
            </div>
          </div>
        </div>
      ...
      <div ref={ubiquitousSection} className={tailwind('relative bg-gray-800')}>
        <div className={tailwind('h-64 bg-gray-800 sm:h-72 md:absolute md:left-0 md:h-full md:w-1/2')}>
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img className={tailwind('h-full w-full object-cover object-top sm:object-contain sm:object-bottom md:ml-3 md:object-cover lg:ml-0 lg:object-contain')} src="/images/ubiquitous.e8204a39a8504e61c183.png" srcSet="/images/ubiquitous.e8204a39a8504e61c183.png 1x, /images/ubiquitous@2x.71c0141141e0fa456d7f.png 2x, /images/ubiquitous@3x.f547ca5abc4dd9ef38e1.png 3x, /images/ubiquitous@4x.18cacd577760c818a450.png 4x" alt="" />
        </div>
          ...
          <div className={tailwind('md:ml-auto md:w-1/2 md:pl-10')}>
            ...
            <div className={tailwind('mt-8 flex justify-center md:justify-start')}>
              <a className={tailwind('group block focus:outline-none')} href="https://apps.apple.com/us/app/id1570111019" target="_blank" rel="noreferrer">
                <Image className={tailwind('h-12 w-auto rounded shadow group-hover:ring group-focus:ring')} src={availableOnAppStore} alt="Available on App Store" />
              </a>
              <a className={tailwind('group ml-4 block focus:outline-none')} href="https://play.google.com/store/apps/details?id=com.justnotecc" target="_blank" rel="noreferrer">
                <Image className={tailwind('h-12 w-auto rounded shadow group-hover:ring group-focus:ring')} src={availableOnPlayStore} alt="Available on Google Play" />
              </a>
            </div>
          </div>
        </div>
              ...
              <ul>
                  ...
                  <figure className={tailwind('mx-auto max-w-2xl rounded-2xl bg-white p-6 shadow-md ring-1 ring-gray-900/5')}>
                    ...
                    <figcaption className={tailwind('mt-6 flex items-center')}>
                      <div className={tailwind('overflow-hidden rounded-full bg-gray-50')}>
                        <Image className={tailwind('h-12 w-12 object-cover')} src={kindWordsJW} alt="" />
                      </div>
                ...
                <li className={tailwind('mt-8')}>
                  <figure className={tailwind('mx-auto max-w-2xl rounded-2xl bg-white p-6 shadow-md ring-1 ring-gray-900/5')}>
                    ...
                    <figcaption className={tailwind('mt-6 flex items-center')}>
                      <div className={tailwind('overflow-hidden rounded-full bg-gray-50')}>
                        <Image className={tailwind('h-12 w-12 object-cover')} src={kindWordsKP} alt="" />
                      </div>
                      <div className={tailwind('ml-4')}>
              ...
              <ul>
                <li className={tailwind('hidden lg:list-item')}>
                  <figure className={tailwind('mx-auto max-w-2xl rounded-2xl bg-white p-6 shadow-md ring-1 ring-gray-900/5')}>
                    ...
                    <figcaption className={tailwind('mt-6 flex items-center')}>
                      <div className={tailwind('overflow-hidden rounded-full bg-gray-50')}>
                        <Image className={tailwind('h-12 w-12 object-cover')} src={kindWordsDH} alt="" />
                      </div>
                      <div className={tailwind('ml-4')}>
                ...
                <li className={tailwind('lg:mt-8')}>
                  <figure className={tailwind('mx-auto max-w-2xl rounded-2xl bg-white p-6 shadow-md ring-1 ring-gray-900/5')}>
                    ...
                    <figcaption className={tailwind('mt-6 flex items-center')}>
                      <div className={tailwind('overflow-hidden rounded-full bg-gray-50')}>
                        <Image className={tailwind('h-12 w-12 object-cover')} src={kindWordsM} alt="" />
                      </div>
                      <div className={tailwind('ml-4')}>
              ...
              <ul>
                <li>
                  <figure className={tailwind('mx-auto max-w-2xl rounded-2xl bg-white p-6 shadow-md ring-1 ring-gray-900/5')}>
                    ...
                    <figcaption className={tailwind('mt-6 flex items-center')}>
                      <div className={tailwind('overflow-hidden rounded-full bg-gray-50')}>
                        <Image className={tailwind('h-12 w-12 object-cover')} src={kindWordsAW} alt="" />
                      </div>
                      <div className={tailwind('ml-4')}>
                ...
                <li className={tailwind('lg:mt-8')}>
                  <figure className={tailwind('mx-auto max-w-2xl rounded-2xl bg-white p-6 shadow-md ring-1 ring-gray-900/5')}>
                    ...
                    <figcaption className={tailwind('mt-6 flex items-center')}>
                      <div className={tailwind('overflow-hidden rounded-full bg-gray-50')}>
                        <Image className={tailwind('h-12 w-12 object-cover')} src={kindWordsII} alt="" />
                      </div>
                      <div className={tailwind('ml-4')}>
      ...
      <section className={tailwind('overflow-hidden bg-white py-12 md:py-20 lg:py-24')}>
        <div className={tailwind('relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8')}>
          <div className={tailwind('relative')}>
            <Image className={tailwind('mx-auto h-8 w-auto')} src={logoFull} alt="Justnote" />
              ...
              <footer className={tailwind('mt-8')}>
                <div className={tailwind('md:flex md:items-center md:justify-center')}>
                  <div className={tailwind('md:flex-shrink-0')}>
                    <Image className={tailwind('mx-auto h-10 w-10 rounded-full')} src={creator} alt="" />
                  </div>
      ...
      <div className={tailwind('bg-white')}>
        <div className={tailwind('mx-auto max-w-7xl py-16 px-4 sm:px-6 lg:px-8')}>
          <div className={tailwind('overflow-hidden rounded-lg bg-green-700 shadow-xl lg:grid lg:grid-cols-2 lg:gap-4')}>
            ...
            <div className={tailwind('aspect-5/3 -mt-6 md:aspect-2/1')}>
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img className={tailwind('translate-x-6 translate-y-6 transform rounded-md object-cover object-left-top sm:translate-x-16 lg:translate-y-20')} src="/images/main-desktop-in-dark-chrome.97c7f9b4e723a4cea91e.png" alt="App screenshot" />
            </div>
          </div>
        </div>
      </div>
