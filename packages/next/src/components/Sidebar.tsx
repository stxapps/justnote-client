  ...
  return (
    <div className={tailwind('flex h-full w-full min-w-56 flex-col bg-gray-100 pt-5 pb-4 blk:bg-gray-800')}>
      <div className={tailwind('flex flex-shrink-0 items-center px-6')}>
        <Image className={tailwind('h-8 w-auto')} src={themeMode === BLK_MODE ? logoFullBlk : logoFull} alt="Justnote" />
      </div>
      <div className={tailwind('flex h-0 flex-1 flex-col')}>
        ...
        <div className={tailwind('mt-6 hidden pl-3 pr-1 lg:block')}>
          <button onClick={onAddBtnClick} type="button" className={tailwind('w-full rounded-md border border-green-600 bg-green-600 py-2 text-sm font-medium text-white shadow-xs hover:bg-green-500 focus:outline-none focus:ring-2 focus:ring-green-600 focus:ring-offset-2 focus:ring-offset-gray-100 blk:focus:ring-offset-gray-800')}>
