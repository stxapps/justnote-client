...
const NoteCommands = (props) => {
  ...
  else btnClassNames = 'border-white bg-white text-gray-500 hover:text-gray-600 focus:text-gray-600 blk:border-gray-900 blk:bg-gray-900 blk:text-gray-400 blk:hover:text-gray-300 blk:focus:text-gray-300 lg:border-gray-300 lg:hover:border-gray-400 lg:focus:text-gray-500 lg:focus-visible:border-gray-400 lg:focus-visible:ring-2 lg:focus-visible:ring-gray-400 lg:focus-visible:ring-offset-2 lg:blk:border-gray-600 lg:blk:hover:border-gray-500 lg:blk:focus:text-gray-400 lg:blk:focus-visible:border-gray-500 lg:blk:focus-visible:ring-gray-500 lg:blk:focus-visible:ring-offset-gray-900';
  ...
  return (
    <React.Fragment>
      {isArchiveBtnShown && <button onClick={onArchiveBtnClick} style={{ maxWidth: '8rem' }} className={tailwind(`group inline-flex h-full items-center border pl-1 pr-1 text-sm focus:outline-none sm:pl-2 lg:rounded-md lg:px-2 lg:py-2 lg:shadow-xs ${btnClassNames}`)} type="button">
        <div className={tailwind(`rounded p-2 lg:p-0 lg:group-focus:bg-transparent lg:blk:group-focus:bg-transparent ${btnInnerClassNames}`)}>
