    ...
    <AnimatePresence key="AP_LockP">
      <div style={canvasStyle} className={tailwind('fixed inset-0 overflow-hidden')}>
        <div className={tailwind('flex items-center justify-center p-4')} style={{ minHeight: theHeight }}>
          ...
          <motion.div className={tailwind('w-full max-w-[23rem] overflow-hidden rounded-lg bg-white shadow-xl blk:bg-gray-800 blk:ring-1 blk:ring-white/25 lg:mb-20')} variants={dialogFMV} initial="hidden" animate="visible" exit="hidden" role="dialog" aria-modal="true" aria-labelledby="modal-headline">
            <div className={tailwind('relative flex flex-col overflow-hidden rounded-lg bg-white blk:bg-gray-800')} style={{ maxHeight: panelHeight }}>
              <div className={tailwind('relative flex-1 overflow-y-auto overflow-x-hidden px-4 pt-8 pb-4 sm:px-6 sm:pb-6')}>
                ...
                {isAddLockNote && <div className={tailwind('mt-5 flex items-center')}>
                  <input onChange={onShowTitleInputChange} checked={doShowTitle} className={tailwind('h-4 w-4 cursor-pointer rounded border-gray-400 text-gray-600 transition duration-150 ease-in-out focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2 blk:border-gray-400 blk:bg-gray-800 blk:text-green-500 blk:checked:bg-green-500 blk:focus:ring-gray-500 blk:focus:ring-offset-gray-800')} id="show-title-input" name="show-title-input" type="checkbox" />
                ...
                {isAddLockMyNotes && <div className={tailwind('mt-5 flex items-center')}>
                  <input onChange={onChangeListNamesInputChange} checked={canChangeListNames} className={tailwind('h-4 w-4 cursor-pointer rounded border-gray-400 text-gray-600 transition duration-150 ease-in-out focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2 blk:border-gray-400 blk:bg-gray-800 blk:text-green-500 blk:checked:bg-green-500 blk:focus:ring-gray-500 blk:focus:ring-offset-gray-800')} id="change-list-names-input" name="change-list-names-input" type="checkbox" />
                ...
                {isAddLock && <div className={tailwind(`flex items-center ${isAddLockNote || isAddLockMyNotes ? 'mt-3.5' : 'mt-5'}`)}>
                  <input onChange={onExportInputChange} checked={canExport} className={tailwind('h-4 w-4 cursor-pointer rounded border-gray-400 text-gray-600 transition duration-150 ease-in-out focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2 blk:border-gray-400 blk:bg-gray-800 blk:text-green-500 blk:checked:bg-green-500 blk:focus:ring-gray-500 blk:focus:ring-offset-gray-800')} id="in-export-input" name="in-export-input" type="checkbox" />
                ...
                <div className={tailwind(errMsg ? '' : isAddLock ? 'pt-5' : 'pt-3.5')}>
                  ...
                  <button onClick={onOkBtnClick} className={tailwind('w-full rounded-md border border-gray-800 bg-gray-800 py-2 text-base font-medium text-white shadow-xs hover:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-600 focus:ring-offset-2 focus:ring-offset-white blk:border-gray-500 blk:bg-gray-500 blk:hover:border-gray-400 blk:hover:bg-gray-400 blk:focus:ring-gray-500 blk:focus:ring-offset-gray-800 sm:text-sm')} type="button">{btnText}</button>
                </div>
