...
const NoteListItemContent = (props) => {
  ...
  return (
    <React.Fragment>
      <div className={tailwind(`group flex items-center rounded-xs pl-3 sm:pl-5 ${viewClassNames}`)}>
        ...
        <div className={tailwind('min-w-0 flex-1')}>
          {(note.title || noteDate) && <div className={tailwind('pr-3')}>
            ...
            <button tabIndex={titleTabIndex} onTouchStart={onTouchPress} onTouchMove={onTouchCancel} onTouchEnd={onTouchPressRelease} onTouchCancel={onTouchCancel} onMouseDown={onClickPress} onMouseUp={onClickPressRelease} onMouseLeave={onClickCancel} className={tailwind(`flex w-full items-center justify-between rounded-xs focus:outline-none focus-visible:ring-2 focus-visible:ring-gray-400 focus-visible:ring-offset-2 blk:focus-visible:ring-gray-500 blk:focus-visible:ring-offset-gray-900 ${titleClassNames}`)}>
          ...
          <div className={tailwind(`flex items-center justify-between ${isBulkEditing ? 'pr-3' : ''}`)}>
            <button tabIndex={bodyTabIndex} onTouchStart={onTouchPress} onTouchMove={onTouchCancel} onTouchEnd={onTouchPressRelease} onTouchCancel={onTouchCancel} onMouseDown={onClickPress} onMouseUp={onClickPressRelease} onMouseLeave={onClickCancel} className={tailwind('min-h-[2.625rem] w-full min-w-0 flex-1 rounded-xs focus:outline-none focus-visible:ring-2 focus-visible:ring-gray-400 focus-visible:ring-offset-2 blk:focus-visible:ring-gray-500 blk:focus-visible:ring-offset-gray-900')}>
            ...
            {!isBulkEditing && <button onClick={onMenuBtnClick} className={tailwind('flex-shrink-0 flex-grow-0 py-1 pl-4 pr-2 text-gray-400 focus:outline-none blk:text-gray-500 group/s')} disabled={isBusy}>
              <svg className={tailwind('w-[1.125rem] rounded-full py-2 group-hover/s:bg-gray-200 group-focus-visible/s:bg-gray-200 blk:group-hover/s:bg-gray-700 blk:group-hover/s:text-gray-400 blk:group-focus-visible/s:bg-gray-700 blk:group-focus-visible/s:text-gray-400')} viewBox="0 0 20 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
