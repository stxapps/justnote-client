    ...
    <div className={tailwind('p-4 md:p-6')}>
      <div className={tailwind('border-b border-gray-200 blk:border-gray-700 md:hidden')}>
        <button onClick={onSidebarOpenBtnClick} className={tailwind('group pb-1 focus:outline-none')}>
          <span className={tailwind('rounded-xs text-sm text-gray-500 group-focus:ring-2 group-focus:ring-gray-400 blk:text-gray-400 blk:ring-gray-500')}>{'<'} <span className={tailwind('group-hover:underline')}>Settings</span></span>
        </button>
      ...
      <div className={tailwind('mt-5 md:mt-0')}>
        <Image className={tailwind('hidden h-7 w-auto md:block')} src={themeMode === BLK_MODE ? shortLogoBlk : shortLogo} alt="Justnote logo" />
        <div className={tailwind('-ml-2 md:flex md:pt-8')}>
          <div className={tailwind('py-2')}>
            <a className={tailwind('block rounded-xs px-2 py-1 text-base text-gray-500 hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-400 blk:text-gray-400 blk:hover:text-white blk:focus:ring-gray-500')} href={'/' + HASH_LANDING} target="_blank" rel="noreferrer">Home page</a>
          </div>
          <div className={tailwind('py-2 md:ml-10')}>
            <a className={tailwind('block rounded-xs px-2 py-1 text-base text-gray-500 hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-400 blk:text-gray-400 blk:hover:text-white blk:focus:ring-gray-500')} href={'/' + HASH_LANDING_MOBILE} target="_blank" rel="noreferrer">Mobile apps</a>
          </div>
        </div>
        <div className={tailwind('-ml-2 pt-8 md:flex')}>
          <div className={tailwind('py-2')}>
            <a className={tailwind('block rounded-xs px-2 py-1 text-base text-gray-500 hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-400 blk:text-gray-400 blk:hover:text-white blk:focus:ring-gray-500')} href={'/' + HASH_ABOUT} target="_blank" rel="noreferrer">About</a>
          </div>
          <div className={tailwind('py-2 md:ml-10')}>
            <a className={tailwind('block rounded-xs px-2 py-1 text-base text-gray-500 hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-400 blk:text-gray-400 blk:hover:text-white blk:focus:ring-gray-500')} href={'/' + HASH_TERMS} target="_blank" rel="noreferrer">Terms</a>
          </div>
          <div className={tailwind('py-2 md:ml-10')}>
            <a className={tailwind('block rounded-xs px-2 py-1 text-base text-gray-500 hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-400 blk:text-gray-400 blk:hover:text-white blk:focus:ring-gray-500')} href={'/' + HASH_PRIVACY} target="_blank" rel="noreferrer">Privacy</a>
          </div>
          <div className={tailwind('py-2 md:ml-10')}>
            <a className={tailwind('block rounded-xs px-2 py-1 text-base text-gray-500 hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-400 blk:text-gray-400 blk:hover:text-white blk:focus:ring-gray-500')} href={'/' + HASH_SUPPORT} target="_blank" rel="noreferrer">Support</a>
          </div>
          <div className={tailwind('hidden py-2 md:ml-10 lg:block')}>
            <a className={tailwind('block rounded-xs px-2 py-1 text-base text-gray-500 hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-400 blk:text-gray-400 blk:hover:text-white blk:focus:ring-gray-500')} href="https://docs.justnote.cc" target="_blank" rel="noreferrer">Docs</a>
          </div>
          <div className={tailwind('hidden py-2 md:ml-10 lg:block')}>
            <a className={tailwind('block rounded-xs px-2 py-1 text-base text-gray-500 hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-400 blk:text-gray-400 blk:hover:text-white blk:focus:ring-gray-500')} href="https://medium.com/@stxapps" target="_blank" rel="noreferrer">Blog</a>
          </div>
        </div>
        ...
        <div className={tailwind('flex items-center justify-start pt-14')}>
          <a className={tailwind('rounded-xs focus:outline-none focus:ring-2 focus:ring-gray-400 blk:focus:ring-gray-500')} href="https://x.com/justnotecc" target="_blank" rel="noreferrer">
          ...
          <a className={tailwind('ml-8 rounded-xs focus:outline-none focus:ring-2 focus:ring-gray-400 blk:focus:ring-gray-500')} href="https://www.threads.net/@justnote.cc" target="_blank" rel="noreferrer">
            <svg className={tailwind('w-8 text-gray-400 hover:text-gray-500 blk:text-gray-500 blk:hover:text-gray-400')} fill="currentColor" viewBox="0 0 192 192" xmlns="http://www.w3.org/2000/svg">
          ...
          <a className={tailwind('ml-8 rounded-xs focus:outline-none focus:ring-2 focus:ring-gray-400 blk:focus:ring-gray-500')} href="https://github.com/stxapps/justnote-client" target="_blank" rel="noreferrer">
