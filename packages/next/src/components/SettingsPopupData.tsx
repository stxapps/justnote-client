  ...
  return (
    <div className={tailwind('p-4 md:p-6')}>
      ...
      <div className={tailwind('mt-8')}>
        <button onClick={onToImportAllDataViewBtnClick} className={tailwind('w-full rounded-xs text-left focus:outline-none focus:ring-2 focus:ring-gray-400 blk:focus:ring-gray-500')}>
      ...
      <div className={tailwind('mt-8')}>
        <button onClick={onToExportAllDataViewBtnClick} className={tailwind('w-full rounded-xs text-left focus:outline-none focus:ring-2 focus:ring-gray-400 blk:focus:ring-gray-500')}>
      ...
      <div className={tailwind('mt-8')}>
        <button onClick={onToDeleteAllDataViewBtnClick} className={tailwind('w-full rounded-xs text-left focus:outline-none focus:ring-2 focus:ring-gray-400 blk:focus:ring-gray-500')}>
      ...
      <div className={tailwind('mt-8 mb-4')}>
        <button onClick={onToDeleteSyncDataViewBtnClick} className={tailwind('w-full rounded-xs text-left focus:outline-none focus:ring-2 focus:ring-gray-400 blk:focus:ring-gray-500')}>
    ...
    <div className={tailwind('p-4 md:p-6 md:pt-4')}>
      <div className={tailwind('border-b border-gray-200 blk:border-gray-700 md:border-b-0')}>
        <button onClick={onBackToDataViewBtnClick} className={tailwind('group pb-1 focus:outline-none md:pb-0')}>
          <span className={tailwind('rounded-xs text-sm text-gray-500 group-focus:ring-2 group-focus:ring-gray-400 blk:text-gray-400 blk:group-focus:ring-gray-500')}>{'<'} <span className={tailwind('group-hover:underline')}>{safeAreaWidth < toPx(MD_WIDTH) ? 'Settings / ' : ''}Data</span></span>
        </button>
...
const InnerSettingsPopupDataDelete = (props) => {
  ...
  if (!deleteAllDataProgress) {
    actionPanel = (
      <div className={tailwind('mt-6 mb-4')}>
        <button onClick={onDeleteAllDataBtnClick} type="button" className={tailwind('block rounded-md border border-gray-300 bg-white px-2 py-2 text-sm text-gray-500 shadow-xs hover:border-gray-400 hover:text-gray-600 focus:border-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2 blk:border-gray-400 blk:bg-gray-900 blk:text-gray-300 blk:hover:border-gray-300 blk:hover:text-gray-200 blk:focus:border-gray-300 blk:focus:ring-gray-500 blk:focus:ring-offset-gray-900')}>
          Delete All My Data
        </button>
  ...
  return (
    <div className={tailwind('p-4 md:p-6 md:pt-4')}>
      ...
      <div className={tailwind('mt-6 flex items-center')}>
        <input onChange={onConfirmInputChange} checked={didCheckConfirm} className={tailwind('h-4 w-4 cursor-pointer rounded border-gray-400 text-gray-600 transition duration-150 ease-in-out focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2 blk:border-gray-400 blk:bg-gray-900 blk:text-green-500 blk:checked:bg-green-500 blk:focus:ring-gray-500 blk:focus:ring-offset-gray-900')} id="confirm-input" name="confirm-input" type="checkbox" />
  ...
  if (!deleteSyncDataProgress) {
    actionPanel = (
      <div className={tailwind('mt-7 mb-4')}>
        <button onClick={onDeleteSyncDataBtnClick} type="button" className={tailwind('block rounded-md border border-gray-300 bg-white px-2 py-2 text-sm text-gray-500 shadow-xs hover:border-gray-400 hover:text-gray-600 focus:border-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2 blk:border-gray-400 blk:bg-gray-900 blk:text-gray-300 blk:hover:border-gray-300 blk:hover:text-gray-200 blk:focus:border-gray-300 blk:focus:ring-gray-500 blk:focus:ring-offset-gray-900')}>
          Clean Up Sync Logs
        </button>
      </div>
    );
