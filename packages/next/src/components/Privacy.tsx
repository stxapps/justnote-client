        ...
        <div className={tailwind('relative overflow-hidden py-16')}>
          ...
          <div className={tailwind('relative px-4 sm:px-6 lg:px-8')}>
            ...
            <div className={tailwind('prose mx-auto mt-10 text-gray-500')}>
              ...
              <p>If you&apos;d like to get your data on our servers or permanently delete it, please contact us, and we will take care of it for you as quickly as possible.</p>
              <h3>Data Transfers</h3>
              <p>Your data is stored on our servers hosted by Google Cloud Platform in the United States. We may also store information on servers and equipment in other countries depending on various factors, including our users&apos; and service providers&apos; locations. These data transfers allow us to provide our services to you. By accessing or using our services or otherwise providing information to us, you understand that your information will be processed, transferred, and stored in the U.S. and other countries, where different data protection standards may apply and/or you may not have the same rights as you do under local law.</p>
            ...
            <div className={tailwind('mx-auto max-w-prose pt-12 text-right text-gray-500')}>
              <button className={tailwind('group rounded-xs hover:text-gray-600 focus:outline-none focus:ring-2 focus:ring-gray-400')} onClick={() => window.scrollTo(0, 0)}>
