...
const NoteListTopBarBulkEdit = () => {
  ...
  return (
    <div className={tailwind('h-16 w-full flex-shrink-0 flex-grow-0 border-b border-gray-200 blk:border-gray-700')}>
      <div className={tailwind('flex h-full w-full justify-between sm:pl-3 sm:pr-6')}>
        <button onClick={onBulkEditCancelBtnClick} className={tailwind('group h-full px-2 text-gray-500 hover:text-gray-700 focus:text-gray-700 focus:outline-none blk:text-gray-400 blk:hover:text-gray-200 blk:focus:text-gray-200')}>
          <div className={tailwind('flex items-center justify-center rounded px-2 py-2 group-focus:bg-gray-200 blk:group-focus:bg-gray-700')}>
            <span className={tailwind('sr-only')}>Cancel bulk edit</span>
            <svg className={tailwind('h-6 w-6')} viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        ...
        <div className={tailwind('flex h-full flex-1 items-center justify-between sm:pl-2')}>
