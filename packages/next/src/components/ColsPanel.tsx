  ...
  const panel = (
    <div style={{ height: safeAreaHeight }} className={tailwind('flex w-full overflow-hidden bg-white blk:bg-gray-900')}>
      ...
      <div className={tailwind(`relative w-2 overflow-visible bg-gray-100 blk:bg-gray-800 ${resizer1Classes}`)}>
        <div onMouseDown={onLeftResizerMouseDown} onTouchStart={onLeftResizerTouchStart} onTouchEnd={onTouchEnd} className={tailwind('h-full w-full cursor-col-resize bg-transparent')} />
        <button onClick={onTogglePane1Shown} className={tailwind('group absolute right-0 bottom-8 h-7 w-5 rounded-l bg-gray-300 shadow-xs focus:outline-none focus:ring-2 focus:ring-gray-400 blk:bg-gray-700 blk:focus:ring-gray-600')}>
      ...
      <div style={{ width: state.pane2Width }} className={tailwind(`relative overflow-hidden bg-white blk:bg-gray-900 ${pane2Classes}`)}>
        <NoteList />
        {!state.isPane1Shown && <button onClick={onTogglePane1Shown} className={tailwind('group absolute left-0 bottom-8 h-7 w-5 rounded-r bg-gray-300 shadow-xs focus:outline-none focus:ring-2 focus:ring-gray-400 blk:bg-gray-600 blk:focus:ring-gray-500')}>
          <svg className={tailwind('h-5 w-5 text-gray-400 group-hover:text-gray-500 blk:text-gray-500 blk:group-hover:text-gray-400')} viewBox="0 0 20 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
      ...
      <div onMouseDown={onRightResizerMouseDown} onTouchStart={onRightResizerTouchStart} onTouchEnd={onTouchEnd} className={tailwind(`relative cursor-col-resize overflow-visible border-l border-gray-100 bg-white pr-1 blk:border-gray-800 blk:bg-gray-900 ${resizer2Classes}`)} />
