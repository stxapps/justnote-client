...
const NoteListItemError = (props) => {
  ...
  return (
    <button onClick={onContentBtnClick} className={tailwind('group flex w-full items-center rounded-xs px-3 py-4 text-left focus:outline-none focus-visible:ring-2 focus-visible:ring-red-300 sm:px-5')}>
      <div className={tailwind('mr-3 flex h-10 w-10 items-center justify-center rounded-full border border-red-100 bg-red-50')}>
        <svg className={tailwind('h-5 w-5 text-red-400')} viewBox="0 0 20 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
