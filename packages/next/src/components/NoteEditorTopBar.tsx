...
const NoteEditorTopBar = (props) => {
  ...
  const renderFocusedCommands = () => {
    return (
      <React.Fragment>
        <button onClick={onCancelBtnClick} type="button" className={tailwind('group hidden border border-white bg-white text-sm text-gray-500 hover:text-gray-600 focus:text-gray-600 focus:outline-none blk:border-gray-900 blk:bg-gray-900 blk:text-gray-400 blk:hover:text-gray-300 blk:focus:text-gray-300 lg:block')}>
          <div className={tailwind('rounded-md px-2 py-1 group-focus:bg-gray-200 blk:group-focus:bg-gray-700')}>Cancel</div>
        </button>
        <button onClick={onSaveBtnClick} type="button" className={tailwind('group inline-flex h-full items-center border border-white bg-white pl-1 pr-1 text-sm text-gray-500 hover:text-gray-600 focus:outline-none blk:border-gray-900 blk:bg-gray-900 blk:text-gray-400 blk:hover:text-gray-300 lg:ml-3 lg:rounded-md lg:border-gray-300 lg:px-2 lg:py-2 lg:shadow-xs lg:hover:border-gray-400 lg:focus:ring-2 lg:focus:ring-green-600/75 lg:focus:ring-offset-2 lg:blk:border-gray-600 lg:blk:hover:border-gray-500 lg:blk:focus:ring-offset-gray-900')}>
          <div className={tailwind('rounded p-2 group-focus:bg-gray-200 blk:group-focus:bg-gray-700 lg:p-0 lg:group-focus:bg-transparent lg:blk:group-focus:bg-transparent')}>
            <svg className={tailwind('h-5 w-5 text-green-600 group-hover:text-green-700 group-focus:text-green-700 blk:text-green-500 blk:group-hover:text-green-400 blk:group-focus:text-green-400 lg:group-focus:text-green-600 lg:blk:group-focus:text-green-400')} viewBox="0 0 20 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ...
    <div id="NoteEditorTopBar" className={tailwind('h-16 w-full flex-shrink-0 flex-grow-0 overflow-x-auto border-b border-gray-200 blk:border-gray-700')}>
      <div style={style} className={tailwind('flex h-full w-full justify-between lg:items-center lg:px-3')}>
        <div className={tailwind('flex')}>
          ...
          <button onClick={onToggleFullScreen} type="button" className={tailwind('hidden items-center rounded-md border border-gray-300 bg-white px-2 py-2 text-sm text-gray-500 shadow-xs hover:border-gray-400 hover:text-gray-600 focus:outline-none focus-visible:border-gray-400 focus-visible:ring-2 focus-visible:ring-gray-400 focus-visible:ring-offset-2 blk:border-gray-600 blk:bg-gray-900 blk:text-gray-400 blk:hover:border-gray-500 blk:hover:text-gray-300 blk:focus-visible:border-gray-500 blk:focus-visible:ring-gray-500 blk:focus-visible:ring-offset-gray-900 lg:inline-flex')}>
