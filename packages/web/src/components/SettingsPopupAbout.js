  ...
  return (
    <div className="p-4 md:p-6">
      ...
      <div className="mt-6 md:mt-0">
        <img className="hidden h-7 md:block" src={shortLogo} alt="Justnote logo" />
        <div className="pt-1 md:pt-10">
          <a className="block text-base text-gray-500 rounded-sm hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-400 md:inline" href={'/' + HASH_LANDING} target="_blank" rel="noreferrer">Home page</a>
          <a className="mt-4 block text-base text-gray-500 rounded-sm hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-400 md:inline md:mt-0 md:ml-14" href={'/' + HASH_LANDING_MOBILE} target="_blank" rel="noreferrer">Mobile apps</a>
        </div>
        <div className="pt-12 text-left md:pt-10">
          <a className="block text-base text-gray-500 rounded-sm hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-400 md:inline" href={'/' + HASH_ABOUT} target="_blank" rel="noreferrer">About</a>
          <a className="mt-4 block text-base text-gray-500 rounded-sm hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-400 md:inline md:mt-0 md:ml-14" href={'/' + HASH_TERMS} target="_blank" rel="noreferrer">Terms</a>
          <a className="mt-4 block text-base text-gray-500 rounded-sm hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-400 md:inline md:mt-0 md:ml-14" href={'/' + HASH_PRIVACY} target="_blank" rel="noreferrer">Privacy</a>
          <a className="mt-4 block text-base text-gray-500 rounded-sm hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-400 md:inline md:mt-0 md:ml-14" href={'/' + HASH_SUPPORT} target="_blank" rel="noreferrer">Support</a>
        </div>
        <div className="pt-16 flex justify-start items-center md:pt-16">
          <a className="rounded-sm focus:outline-none focus:ring-2 focus:ring-gray-400" href="https://twitter.com/justnotecc" target="_blank" rel="noreferrer">
          ...
          <a className="ml-8 rounded-sm focus:outline-none focus:ring-2 focus:ring-gray-400" href="https://github.com/stxapps/justnote-client" target="_blank" rel="noreferrer">
        ...
        <div className="pt-16 lg:flex lg:justify-between">
          <p className="text-base text-gray-400 text-left">© 2022 <a className="text-gray-400 rounded-sm hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-gray-400" href="https://www.stxapps.com" target="_blank" rel="noreferrer">STX Apps Co., Ltd.</a></p>
          <p className="text-base text-gray-400 text-left">All rights reserved.</p>
        </div>
      </div>
    </div>
  );
