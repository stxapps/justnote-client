    ...
    <div className={tailwind('p-4 md:p-6')}>
      ...
      <div className={tailwind('mt-5 md:mt-0')}>
        ...
        <div className={tailwind('flex items-center justify-start pt-14')}>
          <a className={tailwind('rounded-sm focus:outline-none focus:ring-2 focus:ring-gray-400 blk:focus:ring-gray-500')} href="https://twitter.com/justnotecc" target="_blank" rel="noreferrer">
