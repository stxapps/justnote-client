  ...
  return (
    <div className={tailwind('p-4 md:p-6')}>
      ...
      <div className={tailwind('mt-6 md:mt-0')}>
        <img className={tailwind('hidden h-7 md:block')} src={shortLogo} alt="Justnote logo" />
        <div className={tailwind('pt-1 md:pt-10')}>
          <a className={tailwind('block rounded-sm text-base text-gray-500 hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-400 md:inline')} href={'/' + HASH_LANDING} target="_blank" rel="noreferrer">Home page</a>
          <a className={tailwind('mt-4 block rounded-sm text-base text-gray-500 hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-400 md:mt-0 md:ml-14 md:inline')} href={'/' + HASH_LANDING_MOBILE} target="_blank" rel="noreferrer">Mobile apps</a>
        </div>
        <div className={tailwind('pt-12 text-left md:pt-10')}>
          <a className={tailwind('block rounded-sm text-base text-gray-500 hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-400 md:inline')} href={'/' + HASH_ABOUT} target="_blank" rel="noreferrer">About</a>
          <a className={tailwind('mt-4 block rounded-sm text-base text-gray-500 hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-400 md:mt-0 md:ml-14 md:inline')} href={'/' + HASH_TERMS} target="_blank" rel="noreferrer">Terms</a>
          <a className={tailwind('mt-4 block rounded-sm text-base text-gray-500 hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-400 md:mt-0 md:ml-14 md:inline')} href={'/' + HASH_PRIVACY} target="_blank" rel="noreferrer">Privacy</a>
          <a className={tailwind('mt-4 block rounded-sm text-base text-gray-500 hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-400 md:mt-0 md:ml-14 md:inline')} href={'/' + HASH_SUPPORT} target="_blank" rel="noreferrer">Support</a>
        </div>
        <div className={tailwind('flex items-center justify-start pt-16 md:pt-16')}>
          <a className={tailwind('rounded-sm focus:outline-none focus:ring-2 focus:ring-gray-400')} href="https://twitter.com/justnotecc" target="_blank" rel="noreferrer">
          ...
          <a className={tailwind('ml-8 rounded-sm focus:outline-none focus:ring-2 focus:ring-gray-400')} href="https://github.com/stxapps/justnote-client" target="_blank" rel="noreferrer">
        ...
        <div className={tailwind('pt-16 lg:flex lg:justify-between')}>
          <p className={tailwind('text-left text-base text-gray-400')}>© 2022 <a className={tailwind('rounded-sm text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-gray-400')} href="https://www.stxapps.com" target="_blank" rel="noreferrer">STX Apps Co., Ltd.</a></p>
          <p className={tailwind('text-left text-base text-gray-400')}>All rights reserved.</p>
        </div>
      </div>
    </div>
  );
