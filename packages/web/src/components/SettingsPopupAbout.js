    ...
    <div className={tailwind('p-4 md:p-6')}>
      ...
      <div className={tailwind('mt-6 md:mt-0')}>
        ...
        <div className={tailwind('pt-12 text-left md:pt-10')}>
          <a className={tailwind('block rounded-sm text-base text-gray-500 hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-400 blk:text-gray-400 blk:hover:text-white blk:focus:ring-gray-500 md:inline')} href={'/' + HASH_ABOUT} target="_blank" rel="noreferrer">About</a>
          <a className={tailwind('mt-4 block rounded-sm text-base text-gray-500 hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-400 blk:text-gray-400 blk:hover:text-white blk:focus:ring-gray-500 md:mt-0 md:ml-14 md:inline')} href={'/' + HASH_TERMS} target="_blank" rel="noreferrer">Terms</a>
          <a className={tailwind('mt-4 block rounded-sm text-base text-gray-500 hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-400 blk:text-gray-400 blk:hover:text-white blk:focus:ring-gray-500 md:mt-0 md:ml-14 md:inline')} href={'/' + HASH_PRIVACY} target="_blank" rel="noreferrer">Privacy</a>
          <a className={tailwind('mt-4 block rounded-sm text-base text-gray-500 hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-400 blk:text-gray-400 blk:hover:text-white blk:focus:ring-gray-500 md:mt-0 md:ml-14 md:inline')} href={'/' + HASH_SUPPORT} target="_blank" rel="noreferrer">Support</a>
        </div>
