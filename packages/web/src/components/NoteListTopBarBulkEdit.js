...
const NoteListTopBarBulkEdit = () => {
  ...
  return (
    <div className="h-16 border-b border-gray-200 flex items-center justify-between">
      <button onClick={onBulkEditCancelBtnClick} className="h-full px-4 text-gray-500 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-green-600 sm:px-6 lg:hidden">
      ...
      <div className="pl-4 flex-1 h-full flex items-center justify-between sm:pl-6 lg:pl-8">
