...
const IapHome = (props) => {
  ...
  return (
    <div className="mt-6 mb-4 md:mt-0">
      ...
      <p className="mt-5 text-base text-gray-500 leading-relaxed">If you've already purchased the subscription, try <button onClick={onToRestoreIapViewBtnClick} className="underline rounded hover:text-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-400">Restore purchases</button>.</p>
    </div>
  );
};
...
const IapPurchased = (props) => {
  ...
  if (purchase.source === APPSTORE) {
    appStoreLink = (
      <a className="underline rounded hover:text-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-400" href="https://apps.apple.com/account/subscriptions" target="_blank" rel="noreferrer">App Store</a>
    );
  } else if (purchase.source === PLAYSTORE) {
    appStoreLink = (
      <a className="underline rounded hover:text-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-400" href="https://play.google.com/store/account/subscriptions?sku=com.justnotecc.supporter&package=com.justnotecc" target="_blank" rel="noreferrer">Google Play</a>
    );
  }
  ...
  let refreshPanel = (
    <p className="mt-6 text-base text-gray-500 leading-relaxed">{isUnknown ? 'Please wait a moment and try' : 'If your subscription is not up to date, try'} <button onClick={onRefreshBtnClick} className="underline rounded hover:text-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-400">Refresh purchases</button>.</p>
  );
  ...
  return (
    <div className="mt-6 mb-4 md:mt-0">
      ...
      {infoText}
      {refreshPanel}
      <p className="mt-6 text-base text-gray-500 leading-relaxed">{isUnknown ? 'If the problem persists' : 'If you have any question'}, please <a className="underline rounded hover:text-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-400" href={'/' + HASH_SUPPORT} target="_blank" rel="noreferrer">contact us
...
const _SettingsPopupIapRestore = (props) => {
  ...
  if (restoreStatus === null) {
    actionPanel = (
      <button onClick={onRestoreBtnClick} type="button" className="mt-7 mb-4 px-2 py-2 block border border-gray-300 text-sm text-gray-500 rounded-md bg-white shadow-sm hover:text-gray-600 hover:border-gray-400 focus:outline-none focus:border-gray-400 focus:ring-2 focus:ring-offset-2 focus:ring-gray-400">
    ...
    actionPanel = (
      <div className="mt-6 mb-4">
        ...
        <p className="mt-6 text-base text-gray-500 leading-relaxed">Please try to restore purchases in our <a className="underline rounded hover:text-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-400" href={'/' + HASH_LANDING_MOBILE} target="_blank" rel="noreferrer">Mobile apps</a> where you've made the purchase.</p>
        <p className="mt-6 text-base text-gray-500 leading-relaxed">If there's still no purchase found, please <a className="underline rounded hover:text-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-400" href={'/' + HASH_SUPPORT} target="_blank" rel="noreferrer">contact us
          <svg className="mb-2 inline-block w-4" viewBox="0 0 20 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            <path d="M11 3C10.4477 3 10 3.44772 10 4C10 4.55228 10.4477 5 11 5H13.5858L7.29289 11.2929C6.90237 11.6834 6.90237 12.3166 7.29289 12.7071C7.68342 13.0976 8.31658 13.0976 8.70711 12.7071L15 6.41421V9C15 9.55228 15.4477 10 16 10C16.5523 10 17 9.55228 17 9V4C17 3.44772 16.5523 3 16 3H11Z" />
            <path d="M5 5C3.89543 5 3 5.89543 3 7V15C3 16.1046 3.89543 17 5 17H13C14.1046 17 15 16.1046 15 15V12C15 11.4477 14.5523 11 14 11C13.4477 11 13 11.4477 13 12V15H5V7H8C8.55228 7 9 6.55228 9 6C9 5.44772 8.55228 5 8 5H5Z" />
    ...
    actionPanel = (
      <div className="mt-6 mb-4">
        ...
        <p className="mt-6 text-base text-gray-500 leading-relaxed">Please wait a moment and try again. If the problem persists, please <a className="underline rounded hover:text-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-400" href={'/' + HASH_SUPPORT} target="_blank" rel="noreferrer">contact us
          <svg className="mb-2 inline-block w-4" viewBox="0 0 20 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            <path d="M11 3C10.4477 3 10 3.44772 10 4C10 4.55228 10.4477 5 11 5H13.5858L7.29289 11.2929C6.90237 11.6834 6.90237 12.3166 7.29289 12.7071C7.68342 13.0976 8.31658 13.0976 8.70711 12.7071L15 6.41421V9C15 9.55228 15.4477 10 16 10C16.5523 10 17 9.55228 17 9V4C17 3.44772 16.5523 3 16 3H11Z" />
            <path d="M5 5C3.89543 5 3 5.89543 3 7V15C3 16.1046 3.89543 17 5 17H13C14.1046 17 15 16.1046 15 15V12C15 11.4477 14.5523 11 14 11C13.4477 11 13 11.4477 13 12V15H5V7H8C8.55228 7 9 6.55228 9 6C9 5.44772 8.55228 5 8 5H5Z" />
          </svg></a>.
    ...
    <div className="p-4 md:p-6 md:pt-4">
      <div className="border-b border-gray-200 md:border-b-0">
        <button onClick={onBackToIapViewBtnClick} className="pb-1 group focus:outline-none md:pb-0">
          <span className="text-sm text-gray-500 rounded group-focus:ring-2 group-focus:ring-gray-400">{'<'} <span className="group-hover:underline">{safeAreaWidth < SM_WIDTH ? 'Settings / ' : ''}Subscription</span></span>
        </button>
