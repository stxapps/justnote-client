...
const IapHome = (props) => {
  ...
  return (
    <div className={tailwind('mt-6 mb-4 md:mt-0')}>
      ...
      <p className={tailwind('mt-4 text-base leading-relaxed text-gray-500 blk:text-gray-400')}>Support us and unlock extra features: pin to the top, dark appearance, custom date format, section by month, more font sizes, and lock lists & notes.</p>
...
const IapPurchased = (props) => {
  ...
  if (purchase.status === ACTIVE) {
    infoText = (
      <React.Fragment>
        <p className={tailwind('mt-4 text-base leading-relaxed text-gray-500 blk:text-gray-400')}>
          ...
          <span className={tailwind('text-green-600 blk:text-green-500')}>Thank you very much for supporting us.</span> You've unlocked extra features: pin to the top, dark appearance, custom date format, section by month, more font sizes, and lock lists & notes.
        </p>
    ...
    infoText = (
      <React.Fragment>
        <p className={tailwind('mt-4 text-base leading-relaxed text-gray-500 blk:text-gray-400')}>Thank you very much for supporting us. You've unlocked extra features: pin to the top, dark appearance, custom date format, section by month, more font sizes, and lock lists & notes.</p>
