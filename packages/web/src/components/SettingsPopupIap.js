  ...
  if (restoreStatus === null) {
    ...
    actionPanel = (
      <div className={tailwind('mt-6 mb-4')}>
        ...
        <p className={tailwind('mt-6 text-base leading-relaxed text-gray-500 blk:text-gray-400')}>Please try to restore your purchases in our <a className={tailwind('rounded underline hover:text-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-400 blk:hover:text-gray-200 blk:focus:ring-gray-500')} href={'/' + HASH_LANDING_MOBILE} target="_blank" rel="noreferrer">mobile app</a> where you've made the purchases.</p>
