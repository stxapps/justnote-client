              ...
              <div className={tailwind('relative flex-1 overflow-y-auto overflow-x-hidden px-4 pt-8 pb-4 sm:px-6 sm:pb-6')}>
                ...
                <div className={tailwind([LOCK_ACTION_ADD_LOCK_NOTE, LOCK_ACTION_ADD_LOCK_LIST].includes(lockAction) ? 'pt-1' : 'pt-3.5')}>
                  ...
                  <div className={tailwind('relative mt-1 rounded-md bg-white shadow-sm blk:bg-gray-800')}>
                    <input ref={passwordInput} onChange={onPasswordInputChange} className={tailwind('block w-full rounded-md border border-gray-300 bg-white py-2 pl-4 pr-6 text-sm leading-5 text-gray-700 placeholder:text-gray-500 focus:border-gray-500 focus:ring-gray-500 blk:border-gray-600 blk:bg-gray-800 blk:text-gray-200 blk:placeholder:text-gray-400 blk:focus:border-gray-400 blk:focus:ring-gray-400')} placeholder="Password" value={passwordInputValue} id="password-input" name="password-input" autoCapitalize="none" type={doShowPassword ? 'text' : 'password'}></input>
