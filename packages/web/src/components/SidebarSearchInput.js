  ...
  return (
    <div className={tailwind('mt-6 hidden pl-3 pr-1 lg:block')}>
      ...
      <div className={tailwind('relative mt-1 rounded-md bg-white shadow-sm blk:bg-gray-800')}>
        <input onChange={onSearchInputChange} type="search" name="search" id="search" className={tailwind('block w-full rounded-md border border-gray-300 bg-white py-2 pl-9 pr-6 text-sm leading-5 text-gray-700 placeholder:text-gray-500 focus:border-gray-500 focus:ring-gray-500 blk:border-gray-600 blk:bg-gray-800 blk:text-gray-200 blk:placeholder:text-gray-400 blk:focus:border-gray-400 blk:focus:ring-gray-400')} placeholder="Search" value={searchString} autoCapitalize="none" />
