...
const SidebarSearchInput = () => {
  ...
  return (
    <div className={tailwind('mt-6 hidden pl-3 pr-1 lg:block')}>
      ...
      <div className={tailwind('relative mt-1 rounded-md bg-white shadow-sm')}>
        ...
        <input onChange={onSearchInputChange} type="search" name="search" id="search" className={tailwind('block w-full rounded-md border border-gray-300 py-2 pl-9 pr-6 text-sm leading-5 text-gray-700 focus:border-gray-500 focus:ring-gray-500')} placeholder="Search" value={searchString} autoCapitalize="none" />
