  ...
  return (
    <div className="hidden pl-3 pr-1 mt-5 lg:block">
      ...
      <div className="mt-1 relative rounded-md shadow-sm">
        ...
        <input onChange={onSearchInputChange} type="text" name="search" id="search" className="focus:ring-green-600 focus:border-green-600 block w-full pl-9 pr-6 sm:text-sm border-gray-300 rounded-md" placeholder="Search" value={searchString} />
