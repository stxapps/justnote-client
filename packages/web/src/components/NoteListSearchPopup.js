    ...
    <AnimatePresence key="AP_NL_SearchPopup">
      <motion.div className="h-14 border-b border-gray-200 flex items-center justify-between px-4 sm:px-6 lg:hidden" variants={popupFMV} initial="hidden" animate="visible" exit="hidden">
        ...
        <div className="flex-1 relative rounded-md bg-white shadow-sm">
          ...
          <input ref={searchInput} onChange={onSearchInputChange} type="text" name="search" id="search" className="focus:ring-green-600 focus:border-green-600 block w-full pl-9 pr-6 py-1.5 text-base leading-5 text-gray-700 border border-gray-300 rounded-md" placeholder="Search" value={searchString} />
