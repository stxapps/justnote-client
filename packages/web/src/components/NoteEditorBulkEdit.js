    ...
    <div className={tailwind('h-full w-full overflow-x-auto')}>
      <div style={{ minWidth: 400 }} className={tailwind('relative h-full w-full bg-gray-600 px-4 sm:px-6')}>
        ...
        <button onClick={onExitBtnClick} className={tailwind('group absolute top-4 right-4 p-3 text-white focus:outline-none')}>
          <svg className={tailwind('h-4 w-4 rounded group-hover:ring-1 group-hover:ring-white group-focus:ring-2 group-focus:ring-white')} viewBox="0 0 20 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
