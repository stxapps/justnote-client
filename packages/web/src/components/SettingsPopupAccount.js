          ...
          <tbody>
            ...
            <tr className="py-4">
              ...
              <td className="pl-2 align-baseline">
                ...
                <p className="pt-2 text-base text-blue-500 leading-relaxed underline hover:text-blue-700"><a className="rounded-sm focus:outline-none focus:ring-2 focus:ring-blue-400" href="https://app.blockstack.org/#/settings/secret-key">View your 12-word secret key</a></p>
              </td>
            </tr>
          </tbody>
        </table>
