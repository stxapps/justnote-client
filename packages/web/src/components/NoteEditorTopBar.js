...
const NoteEditorTopBar = (props) => {
  ...
  const renderFocusedCommands = () => {
    return (
      <React.Fragment>
        <button onClick={onCancelBtnClick} type="button" className="hidden border border-white text-sm bg-white focus:outline-none px-2 py-2 rounded-md shadow-sm focus:ring-2 focus:ring-green-600 text-gray-500 hover:text-gray-600 hover:bg-gray-50 lg:inline">
          Cancel
        </button>
