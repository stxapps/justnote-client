...
const NoteEditorTopBar = (props) => {
  ...
  const renderFocusedCommands = () => {
    return (
      <React.Fragment>
        <button onClick={onCancelBtnClick} type="button" className="hidden border border-white text-sm text-gray-500 bg-white group hover:text-gray-600 focus:outline-none focus:text-gray-600 lg:block">
          <div className="px-2 py-1 rounded-md group-focus:bg-gray-200">Cancel</div>
        </button>
        <button onClick={onSaveBtnClick} type="button" className="group inline-flex items-center h-full pl-1 pr-1 border border-white text-sm bg-white focus:outline-none lg:px-2 lg:py-2 lg:border-gray-300 lg:rounded-md lg:shadow-sm lg:focus:ring-2 lg:focus:ring-offset-2 lg:focus:ring-green-600 lg:focus:ring-opacity-75 text-gray-500 hover:text-gray-600 lg:hover:border-gray-400 lg:ml-3">
          <div className="p-2 rounded group-focus:bg-gray-200 lg:p-0 lg:group-focus:bg-transparent">
            <svg className="h-5 w-5 text-green-600 group-hover:text-green-700 group-focus:text-green-700 lg:group-focus:text-green-600" viewBox="0 0 20 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
  ...
  return (
    <div className="flex-grow-0 flex-shrink-0 border-b border-gray-200 w-full h-16 overflow-x-auto">
      <div style={style} className="w-full h-full flex justify-between lg:px-3 lg:items-center">
        <div className="flex">
          <button onClick={onRightPanelCloseBtnClick} type="button" className="group inline-flex items-center px-4 h-full text-sm text-gray-500 bg-white hover:text-gray-700 focus:outline-none focus-visible:text-gray-700 focus-visible:bg-gray-200 lg:hidden">
          ...
          <button onClick={onToggleFullScreen} type="button" className="hidden items-center px-2 py-2 border border-gray-300 shadow-sm text-sm rounded-md text-gray-500 bg-white hover:text-gray-600 hover:border-gray-400 focus:outline-none focus-visible:border-gray-400 focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-gray-400 lg:inline-flex">
            <svg className="mr-1 h-5 w-5" viewBox="0 0 20 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
