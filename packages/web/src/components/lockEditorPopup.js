...
import {
  ...
  LOCK_ACTION_REMOVE_LOCK_NOTE, LOCK_ACTION_UNLOCK_NOTE, LOCK_ACTION_ADD_LOCK_LIST,
  LOCK_ACTION_REMOVE_LOCK_LIST, LOCK_ACTION_UNLOCK_LIST,
} from '../types/const';
...
const LockEditorPopup = () => {
  ...
  return (
    <AnimatePresence key="AP_LockP">
      <div className={tailwind('absolute inset-0 overflow-hidden')}>
        <div className={tailwind('flex items-center justify-center p-4')} style={{ minHeight: safeAreaHeight }}>
          <div className={tailwind('absolute inset-0')}>
              ...
              <div ref={scrollView} className={tailwind('relative flex-1 overflow-y-auto overflow-x-hidden px-4 sm:px-6')}>
                ...
                <div className={tailwind('pt-3.5')}>
                  ...
                  <div className={tailwind('relative mt-1 rounded-md bg-white shadow-sm blk:bg-gray-800')}>
                    <input ref={passwordInput} onChange={onPasswordInputChange} className={tailwind('block w-full rounded-md border border-gray-300 py-2 pl-4 pr-6 text-sm leading-5 text-gray-700 focus:border-gray-500 focus:ring-gray-500 blk:border-gray-600 blk:text-gray-200 blk:focus:border-gray-400 blk:focus:ring-gray-400')} value={passwordInputValue} id="password-input" name="password-input" autoCapitalize="none" type={doShowPassword ? 'text' : 'password'}></input>
                ...
                <div className={tailwind(errMsg ? '' : 'pt-5')}>
                  ...
                  <button onClick={onOkBtnClick} className={tailwind('w-full rounded-md border border-transparent bg-blue-700 py-2 px-4 text-sm font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2')} type="button">Continue</button>
                </div>
