...
import {
  ...
  updateDeletingListName, updateListNameEditors, updatePopupUrlHash,
} from '../actions';
import {
    ...
    if (listNameObj && listNameObj.children && listNameObj.children.length > 0) {
      ...
      expandBtn = (
        <button onClick={onExpandBtnClick} className={tailwind('group flex h-10 w-8 flex-shrink-0 flex-grow-0 items-center justify-start focus:outline-none')}>
          <div className={tailwind('flex h-3.5 w-3.5 items-center justify-center rounded-sm text-gray-500 group-hover:text-gray-600 group-focus:ring-2 group-focus:ring-gray-400 group-focus:ring-offset-4 blk:text-gray-400 blk:group-hover:text-gray-200 blk:group-focus:ring-offset-gray-900')}>
            {expandSvg}
          </div>
        </button>
      );
    ...
    <React.Fragment>
      <div style={viewStyle} className={tailwind('mt-1 flex items-center justify-start')}>
        ...
        {state.mode === MODE_EDIT && <button onTouchStart={onCancelBtnPress} onMouseDown={onCancelBtnPress} onClick={onCancelBtnClick} className={tailwind('group flex h-10 w-8 flex-shrink-0 flex-grow-0 items-center justify-start focus:outline-none')}>
          <svg className={tailwind('h-3 w-3 rounded-sm text-gray-500 group-hover:text-gray-600 group-focus:ring-2 group-focus:ring-gray-400 group-focus:ring-offset-4 blk:text-gray-400 blk:group-hover:text-gray-200 blk:group-focus:ring-offset-gray-900')} viewBox="0 0 12 12" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        {state.mode === MODE_EDIT && <button onTouchStart={onOkBtnPress} onMouseDown={onOkBtnPress} onClick={onOkBtnClick} className={tailwind('group flex h-10 w-10 flex-shrink-0 flex-grow-0 items-center justify-center focus:outline-none')}>
          <svg className={tailwind('w-4 rounded-sm text-gray-500 group-hover:text-gray-600 group-focus:ring-2 group-focus:ring-gray-400 group-focus:ring-offset-4 blk:text-gray-400 blk:group-hover:text-gray-200 blk:group-focus:ring-offset-gray-900')} viewBox="0 0 14 10" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        {(state.mode === MODE_VIEW && listNameObj !== null) && <button onClick={onEditBtnClick} className={tailwind('group hidden h-10 w-10 flex-shrink-0 flex-grow-0 items-center justify-center focus:outline-none sm:flex')} disabled={isBusy}>
          <svg className={tailwind('w-4 rounded-sm text-gray-500 group-hover:text-gray-600 group-focus:ring-2 group-focus:ring-gray-400 group-focus:ring-offset-4 blk:text-gray-400 blk:group-hover:text-gray-200 blk:group-focus:ring-offset-gray-900')} viewBox="0 0 14 14" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        {(state.mode === MODE_VIEW && listNameObj !== null) && <button onClick={onMoveUpBtnClick} className={tailwind('group hidden h-10 w-10 flex-shrink-0 flex-grow-0 items-center justify-center focus:outline-none lg:flex')} disabled={isBusy}>
          <svg className={tailwind('h-4 rounded-sm text-gray-500 group-hover:text-gray-600 group-focus:ring-2 group-focus:ring-gray-400 group-focus:ring-offset-4 blk:text-gray-400 blk:group-hover:text-gray-200 blk:group-focus:ring-offset-gray-900')} viewBox="0 0 14 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        {(state.mode === MODE_VIEW && listNameObj !== null) && <button onClick={onMoveDownBtnClick} className={tailwind('group hidden h-10 w-10 flex-shrink-0 flex-grow-0 items-center justify-center focus:outline-none lg:flex')} disabled={isBusy}>
          <svg className={tailwind('h-4 rounded-sm text-gray-500 group-hover:text-gray-600 group-focus:ring-2 group-focus:ring-gray-400 group-focus:ring-offset-4 blk:text-gray-400 blk:group-hover:text-gray-200 blk:group-focus:ring-offset-gray-900')} viewBox="0 0 14 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
