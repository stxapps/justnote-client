        ...
        <div className={tailwind('relative overflow-hidden py-16')}>
          ...
          <div className={tailwind('relative px-4 sm:px-6 lg:px-8')}>
            ...
            <div className={tailwind('prose mx-auto mt-12 text-gray-500')}>
              <p>Justnote is a service to help people take notes. We provide a simple, easy and convenient way of taking notes on any device. Users can take a note on our website or our mobile app which is available on both Android and iOS. Our WYSIWYG rich text editor is world class with features like bold, underline, font color, and background color. All notes are synced across the user's devices automatically. Our goal is to provide our users the best experience. We're inspired by <a href="https://evernote.com/" target="_blank" rel="noreferrer">Evernote</a>, <a href="https://www.google.com/keep" target="_blank" rel="noreferrer">Google Keep</a>, <a href="https://joplinapp.org/" target="_blank" rel="noreferrer">Joplin</a>, <a href="https://www.notion.so/" target="_blank" rel="noreferrer">Notion</a>, and many more.</p>
              <p>Privacy is at our heart. That's why we choose <a href="https://www.stacks.co/" target="_blank" rel="noreferrer">Stacks</a>. Stacks provides tools and libraries for building an app that respects our users' privacy. User identities live in the blockchain securely and cannot be locked, banned, or deleted by Justnote or anyone. All notes at Justnote are encrypted, no one can see their content. Even Justnote cannot see notes users save. Also, users can set up their own server to save their notes if they want.</p>
