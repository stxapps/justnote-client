        ...
        <div className="relative py-16 overflow-hidden">
          ...
          <div className="relative px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-12 prose text-gray-500 mx-auto">
              <p>Justnote is a service to help people take notes. We provide a simple, easy and convenient way of taking notes on any devices. Users can take a note on our website or our mobile app which is available on both Android and iOS. Our WYSIWYG rich text editor is world class with features like bold, underline, font color, and background color. All notes are synced across user's devices automatically. Our goal is to provide our users the best experience. We're inspired by <a href="https://evernote.com/">Evernote</a>, <a href="https://keep.google.com">Google Keep</a>, <a href="https://joplinapp.org/">Joplin</a>, <a href="https://www.notion.so/">Notion</a>, and many more.</p>
              <p>Privacy is at our heart. That's why we choose <a href="https://www.stacks.co/">Stacks</a>. Stacks provides tools and libraries for building an app that respects our users' privacy. User identities live in blockchain securely and cannot be locked, banned, or deleted by Justnote or anyone. All notes at Justnote are encrypted, no one can see their content. Even Justnote cannot see notes users save. Also, users can setup their own server to save their notes if they want.</p>
              <p>Justnote is open sourced and published at <a href="https://github.com/justnotecc">Github.com</a>. It's built with many tools and libraries. The list is not exhausive and continue to grow: <a href="https://reactjs.org/">React</a>, <a href="https://create-react-app.dev/">Create React App</a>, <a href="https://react-redux.js.org/">React Redux</a>, <a href="https://redux.js.org">Redux</a>, <a href="https://github.com/reduxjs/redux-thunk">Redux Thunk</a>, <a href="https://redux-loop.js.org/">Redux Loop</a>, <a href="https://reactnative.dev/">React Native</a>, <a href="https://www.framer.com/motion/">Framer Motion</a>, and <a href="https://ckeditor.com/">CKEditor</a>. Justnote cannot go this far without these tools and libraries. Really appreciate.</p>
              <p>We know that design is very important. Our user interface needs to be slick, intuitive, and beautiful. We use <a href="https://www.figma.com/">Figma</a> to design and <a href="https://tailwindui.com/">TailwindUI</a> to style. Many icons and illustrations are from <a href="https://www.heroicons.com/">Heroicons</a>, <a href="https://iconmonstr.com/">iconmonstr</a>, <a href="https://undraw.co/">unDraw.co</a>, <a href="https://loading.io/">Loading.io</a>, and <a href="https://connoratherton.com/loaders">Loaders.css</a>. We learn a lot from Adam Wathan's <a href="https://www.youtube.com/channel/UCy1H38XrN7hi7wHSClfXPqQ">youtube channel</a> and <a href="https://refactoringui.com/">RefactoringUI book</a> from Steve Schoger. We'd like to thank all of them very much.</p>
              <p>Currently, Justnote is free. In the future, we plan to have a subscription plan like $0.99 US Dollar per year. We believe if our service is useful, our users will support us. We wouldn't force it in any way. If users aren't ready, they will always be able to close the popup and continue using.</p>
