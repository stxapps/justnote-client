        ...
        <div className={tailwind('relative overflow-hidden py-16')}>
          ...
          <div className={tailwind('relative px-4 sm:px-6 lg:px-8')}>
            ...
            <div className={tailwind('prose mx-auto mt-12 text-gray-500')}>
              ...
              <p>Privacy is at our heart. That's why we chose <a href="https://www.hiro.so/stacks-js" target="_blank" rel="noreferrer">Stacks</a>. Stacks provides tools and libraries for building a website/app that protects users' privacy. <a href="https://docs.stacks.co/stacks-101/accounts" target="_blank" rel="noreferrer">A decentralized account</a> generated by a cryptographic algorithm cannot be locked, banned, or deleted by Justnote or anyone. It provides a private key to encrypt everything. No one can see the content inside encrypted data; even Justnote cannot see the notes users save. Also, the account can access <a href="https://explorer.hiro.so" target="_blank" rel="noreferrer">the Stacks blockchain</a>, so users can set up <a href="https://docs.stacks.co/stacks-in-depth/gaia" target="_blank" rel="noreferrer">their own server</a> to store their notes. Just save the server location on the blockchain; Justnote will read the location and store data on the specified data server.</p>
