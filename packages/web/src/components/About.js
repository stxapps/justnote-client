        ...
        <div className={tailwind('relative overflow-hidden py-16')}>
          ...
          <div className={tailwind('relative px-4 sm:px-6 lg:px-8')}>
            ...
            <div className={tailwind('prose mx-auto mt-12 text-gray-500')}>
              ...
              <p>Justnote is open sourced and published at <a href="https://github.com/stxapps/justnote-client" target="_blank" rel="noreferrer">Github.com</a>. It's built with many tools and libraries. The list is not exhausive and continue to grow: <a href="https://reactjs.org/" target="_blank" rel="noreferrer">React</a>, <a href="https://create-react-app.dev/" target="_blank" rel="noreferrer">Create React App</a>, <a href="https://react-redux.js.org/" target="_blank" rel="noreferrer">React Redux</a>, <a href="https://redux.js.org" target="_blank" rel="noreferrer">Redux</a>, <a href="https://github.com/reduxjs/redux-thunk" target="_blank" rel="noreferrer">Redux Thunk</a>, <a href="https://redux-loop.js.org/" target="_blank" rel="noreferrer">Redux Loop</a>, <a href="https://reactnative.dev/" target="_blank" rel="noreferrer">React Native</a>, <a href="https://www.framer.com/motion/" target="_blank" rel="noreferrer">Framer Motion</a>, and <a href="https://ckeditor.com/" target="_blank" rel="noreferrer">CKEditor</a>. Justnote cannot go this far without these tools and libraries. Really appreciate.</p>
              ...
              <p>It's our intention to keep all of the current free features free forever and to never show advertisments. We believe if our service is useful, our users will support us. We wouldn't force it in any way. If users aren't ready, they will always be able to close the popup and continue using.</p>
