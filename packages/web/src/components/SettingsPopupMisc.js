          ...
          <div className="m-4 p-4 bg-red-50 rounded-md shadow-lg">
            <div className="flex">
              ...
              <div className="ml-3">
                ...
                <p className="mt-2.5 text-base text-red-700">Please wait a moment and try again. <br className="hidden sm:inline" />If the problem persists, please <a className="underline hover:text-red-800 focus:outline-none focus:ring-2 focus:ring-green-600" href="/support">contact us
