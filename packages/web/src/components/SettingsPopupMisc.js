...
const SettingsPopupMisc = (props) => {
  ...
  const doDeleteBtnClassNames = doDeleteOldNotesInTrash ? 'bg-green-500 blk:bg-green-600' : 'bg-gray-200 blk:bg-gray-700';
  ...
  const addedDTRadioClassNames = sortOn === ADDED_DT ? 'focus:ring-offset-green-100 blk:focus:ring-gray-800 blk:focus:ring-offset-green-600' : 'blk:focus:ring-offset-gray-900';
  ...
  const updatedDTRadioClassNames = sortOn === UPDATED_DT ? 'focus:ring-offset-green-100 blk:focus:ring-gray-800 blk:focus:ring-offset-green-600' : 'blk:focus:ring-offset-gray-900';
  ...
  const ascendingRadioClassNames = !doDescendingOrder ? 'focus:ring-offset-green-100 blk:focus:ring-gray-800 blk:focus:ring-offset-green-600' : 'blk:focus:ring-offset-gray-900';
  ...
  const descendingRadioClassNames = doDescendingOrder ? 'focus:ring-offset-green-100 blk:focus:ring-gray-800 blk:focus:ring-offset-green-600' : 'blk:focus:ring-offset-gray-900';

  const doShowDate = noteDateShowingMode === NOTE_DATE_SHOWING_MODE_SHOW_DEFAULT;
  const doShowDateBtnClassNames = doShowDate ? 'bg-green-500 blk:bg-green-600' : 'bg-gray-200 blk:bg-gray-700';
  const doShowDateBtnInnerClassNames = doShowDate ? 'translate-x-5' : 'translate-x-0';

  const whtBtnClassNames = themeMode === WHT_MODE ? 'bg-green-100 border-green-200 blk:bg-blue-600 blk:border-blue-700' : 'border-gray-200 blk:border-gray-700';
  const whtBtnInnerClassNames = themeMode === WHT_MODE ? 'text-green-800 blk:text-blue-100' : 'text-gray-600 blk:text-gray-300';
  const whtRadioClassNames = themeMode === WHT_MODE ? 'focus:ring-offset-green-100 blk:focus:ring-gray-800 blk:focus:ring-offset-green-600' : 'blk:focus:ring-offset-gray-900';
  const blkBtnClassNames = themeMode === BLK_MODE ? 'bg-green-100 border-green-200 blk:bg-blue-600 blk:border-blue-700' : 'border-gray-200 blk:border-gray-700';
  const blkBtnInnerClassNames = themeMode === BLK_MODE ? 'text-green-800 blk:text-blue-100' : 'text-gray-600 blk:text-gray-300';
  const blkRadioClassNames = themeMode === BLK_MODE ? 'focus:ring-offset-green-100 blk:focus:ring-gray-800 blk:focus:ring-offset-green-600' : 'blk:focus:ring-offset-gray-900';
  const systemBtnClassNames = themeMode === SYSTEM_MODE ? 'bg-green-100 border-green-200 blk:bg-blue-600 blk:border-blue-700' : 'border-gray-200 blk:border-gray-700';
  const systemBtnInnerClassNames = themeMode === SYSTEM_MODE ? 'text-green-800 blk:text-blue-100' : 'text-gray-600 blk:text-gray-300';
  const systemRadioClassNames = themeMode === SYSTEM_MODE ? 'focus:ring-offset-green-100 blk:focus:ring-gray-800 blk:focus:ring-offset-green-600' : 'blk:focus:ring-offset-gray-900';
  const customBtnClassNames = themeMode === CUSTOM_MODE ? 'bg-green-100 border-green-200 blk:bg-blue-600 blk:border-blue-700' : 'border-gray-200 blk:border-gray-700';
  const customBtnInnerClassNames = themeMode === CUSTOM_MODE ? 'text-green-800 blk:text-blue-100' : 'text-gray-600 blk:text-gray-300';
  const customRadioClassNames = themeMode === CUSTOM_MODE ? 'focus:ring-offset-green-100 blk:focus:ring-gray-800 blk:focus:ring-offset-green-600' : 'blk:focus:ring-offset-gray-900';

  const customTextClassNames = themeMode === CUSTOM_MODE ? 'text-green-700 blk:text-green-200' : 'text-gray-500 blk:text-gray-500';
  const customInputClassNames = themeMode === CUSTOM_MODE ? 'text-gray-600 focus:border-gray-500 focus:ring-gray-500 blk:border-green-200 blk:bg-green-600 blk:text-green-100 blk:focus:ring-green-200' : 'text-gray-400 blk:border-gray-600 blk:bg-gray-900 blk:text-gray-500';
  ...
  return (
    <div className={tailwind('relative p-4 md:p-6')}>
        ...
        <div className={tailwind('mx-auto mt-2.5 w-full max-w-sm -space-y-px rounded-md bg-white shadow-sm blk:bg-gray-900')}>
          <div className={tailwind(`relative flex rounded-tl-md rounded-tr-md border p-4 ${whtBtnClassNames}`)}>
            <div className={tailwind('flex h-5 items-center')}>
              <input onChange={onThemeInputChange} id="theme-mode-option-1" name="theme-mode-option-1" type="radio" className={tailwind(`h-4 w-4 cursor-pointer text-green-600 transition duration-150 ease-in-out focus:ring-2 focus:ring-green-600 focus:ring-offset-2 blk:bg-gray-900 blk:text-green-400 ${whtRadioClassNames}`)} checked={themeMode === WHT_MODE} value={WHT_MODE} />
            </div>
          ...
          <div className={tailwind(`relative flex border p-4 ${blkBtnClassNames}`)}>
            <div className={tailwind('flex h-5 items-center')}>
              <input onChange={onThemeInputChange} id="theme-mode-option-2" name="theme-mode-option-2" type="radio" className={tailwind(`h-4 w-4 cursor-pointer text-green-600 transition duration-150 ease-in-out focus:ring-2 focus:ring-green-600 focus:ring-offset-2 blk:bg-gray-900 blk:text-green-400 ${blkRadioClassNames}`)} checked={themeMode === BLK_MODE} value={BLK_MODE} />
            </div>
          ...
          <div className={tailwind(`relative flex border p-4 ${systemBtnClassNames}`)}>
            <div className={tailwind('flex h-5 items-center')}>
              <input onChange={onThemeInputChange} id="theme-mode-option-3" name="theme-mode-option-3" type="radio" className={tailwind(`h-4 w-4 cursor-pointer text-green-600 transition duration-150 ease-in-out focus:ring-2 focus:ring-green-600 focus:ring-offset-2 blk:bg-gray-900 blk:text-green-400 ${systemRadioClassNames}`)} checked={themeMode === SYSTEM_MODE} value={SYSTEM_MODE} />
            </div>
          ...
          <div className={tailwind(`relative flex rounded-bl-md rounded-br-md border p-4 ${customBtnClassNames}`)}>
            <div className={tailwind('flex h-5 items-center')}>
              <input onChange={onThemeInputChange} id="theme-mode-option-4" name="theme-mode-option-4" type="radio" className={tailwind(`h-4 w-4 cursor-pointer text-green-600 transition duration-150 ease-in-out focus:ring-2 focus:ring-green-600 focus:ring-offset-2 blk:bg-gray-900 blk:text-green-400 ${customRadioClassNames}`)} checked={themeMode === CUSTOM_MODE} value={CUSTOM_MODE} />
            </div>
        ...
        <div className={tailwind('sm:flex sm:items-start sm:justify-between sm:space-x-4')}>
          ...
          <div className={tailwind('mx-auto mt-2.5 w-full max-w-48 -space-y-px rounded-md bg-white shadow-sm blk:bg-gray-900 sm:mt-1 sm:w-48 sm:max-w-none sm:flex-shrink-0 sm:flex-grow-0')}>
            <div className={tailwind(`relative flex rounded-tl-md rounded-tr-md border p-4 ${addedDTBtnClassNames}`)}>
              <div className={tailwind('flex h-5 items-center')}>
                <input onChange={onSortOnInputChange} id="list-order-on-option-1" name="list-order-on-option-1" type="radio" className={tailwind(`h-4 w-4 cursor-pointer text-green-600 transition duration-150 ease-in-out focus:ring-2 focus:ring-green-600 focus:ring-offset-2 blk:bg-gray-900 blk:text-green-400 ${addedDTRadioClassNames}`)} checked={sortOn === ADDED_DT} value={ADDED_DT} />
              </div>
            ...
            <div className={tailwind(`relative flex rounded-bl-md rounded-br-md border p-4 ${updatedDTBtnClassNames}`)}>
              <div className={tailwind('flex h-5 items-center')}>
                <input onChange={onSortOnInputChange} id="list-order-on-option-2" name="list-order-on-option-2" type="radio" className={tailwind(`h-4 w-4 cursor-pointer text-green-600 transition duration-150 ease-in-out focus:ring-2 focus:ring-green-600 focus:ring-offset-2 blk:bg-gray-900 blk:text-green-400 ${updatedDTRadioClassNames}`)} checked={sortOn === UPDATED_DT} value={UPDATED_DT} />
              </div>
      ...
      <div className={tailwind('mt-10 flex flex-col')}>
        <h4 className={tailwind('text-base font-medium leading-none text-gray-800 blk:text-gray')}>List Order Direction</h4>
        <div className={tailwind('sm:flex sm:items-start sm:justify-between sm:space-x-4')}>
          ...
          <div className={tailwind('mx-auto mt-2.5 w-full max-w-48 -space-y-px rounded-md bg-white shadow-sm blk:bg-gray-900 sm:mt-1 sm:w-48 sm:max-w-none sm:flex-shrink-0 sm:flex-grow-0')}>
            <div className={tailwind(`relative flex rounded-tl-md rounded-tr-md border p-4 ${ascendingBtnClassNames}`)}>
              <div className={tailwind('flex h-5 items-center')}>
                <input onChange={onDoDescendingInputChange} id="list-order-direction-option-1" name="list-order-direction-option-1" type="radio" className={tailwind(`h-4 w-4 cursor-pointer text-green-600 transition duration-150 ease-in-out focus:ring-2 focus:ring-green-600 focus:ring-offset-2 blk:bg-gray-900 blk:text-green-400 ${ascendingRadioClassNames}`)} checked={!doDescendingOrder} value="ascending" />
              </div>
            ...
            <div className={tailwind(`relative flex rounded-bl-md rounded-br-md border p-4 ${descendingBtnClassNames}`)}>
              <div className={tailwind('flex h-5 items-center')}>
                <input onChange={onDoDescendingInputChange} id="list-order-direction-option-2" name="list-order-direction-option-2" type="radio" className={tailwind(`h-4 w-4 cursor-pointer text-green-600 transition duration-150 ease-in-out focus:ring-2 focus:ring-green-600 focus:ring-offset-2 blk:bg-gray-900 blk:text-green-400 ${descendingRadioClassNames}`)} checked={doDescendingOrder} value="descending" />
              </div>
