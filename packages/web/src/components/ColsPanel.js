...
const ColsPanel = () => {
  ...
  return (
    <div style={{ height: safeAreaHeight }} className={tailwind('flex w-full overflow-hidden bg-white blk:bg-gray-900')}>
      ...
      <div onMouseDown={onLeftResizerMouseDown} onTouchStart={onLeftResizerTouchStart} onTouchEnd={onTouchEnd} className={tailwind(`relative w-2 cursor-resize overflow-visible bg-gray-100 blk:bg-gray-800 ${resizer1Classes}`)}>
