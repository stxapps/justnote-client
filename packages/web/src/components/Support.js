        ...
        <div className="relative py-16 overflow-hidden">
          ...
          <div className="relative px-4 sm:px-6 lg:px-8">
            <div className="max-w-prose mx-auto">
              ...
              <p className="mt-5 text-base text-gray-500">Please feel free to contact us.</p>
            </div>
            <div className="pt-12 max-w-prose mx-auto">
              <div className="grid grid-cols-1 gap-y-14 sm:grid-cols-3 sm:gap-y-0 sm:gap-x-8">
                <a className="block text-center rounded group focus:outline-none focus:ring-2 focus:ring-green-600" href="https://twitter.com/justnotecc" target="_blank" rel="noreferrer">
                  <div className="mt-2 p-4 inline-block bg-green-500 rounded-xl shadow-lg group-hover:bg-green-400">
                ...
                <a className="block text-center rounded group focus:outline-none focus:ring-2 focus:ring-green-600" href="https://github.com/justnotecc/justnote-client/issues" target="_blank" rel="noreferrer">
                  <div className="mt-2 p-4 inline-block bg-green-500 rounded-xl shadow-lg group-hover:bg-green-400">
                ...
                <a className="block text-center rounded group focus:outline-none focus:ring-2 focus:ring-green-600" href="&#109;&#97;&#105;&#108;&#116;&#111;&#58;&#115;&#117;&#112;&#112;&#111;&#114;&#116;&#64;&#106;&#117;&#115;&#116;&#110;&#111;&#116;&#101;&#46;&#99;&#99;">
                  <div className="mt-2 p-4 inline-block bg-green-500 rounded-xl shadow-lg group-hover:bg-green-400">
