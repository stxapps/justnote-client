        ...
        <div className="relative py-16 overflow-hidden">
          ...
          <div className="relative px-4 sm:px-6 lg:px-8">
            <div className="max-w-prose mx-auto">
              <h1 className="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">Support</h1>
              <p className="mt-5 text-lg text-gray-500">Please feel free to contact us.</p>
            </div>
            <div className="pt-12 max-w-prose mx-auto">
              <div className="grid grid-cols-1 gap-y-14 sm:grid-cols-3 sm:gap-y-0 sm:gap-x-8">
                <a className="block text-center rounded focus:outline-none focus:ring-2 focus:ring-green-600" href="https://twitter.com/justnotecc">
                  <div className="mt-2 p-4 inline-block bg-green-500 rounded-xl shadow-lg">
                    <svg className="h-6 w-6 text-white" viewBox="0 0 40 32" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <h3 className="text-base font-normal text-gray-700">Twitter</h3>
                </a>
                <a className="block text-center rounded focus:outline-none focus:ring-2 focus:ring-green-600" href="https://github.com/justnotecc">
                  <div className="mt-2 p-4 inline-block bg-green-500 rounded-xl shadow-lg">
                    <svg className="h-6 w-6 text-white" viewBox="0 0 33 32" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <h3 className="text-base font-normal text-gray-700">Github</h3>
                </a>
                <a className="block text-center rounded focus:outline-none focus:ring-2 focus:ring-green-600" href="&#109;&#97;&#105;&#108;&#116;&#111;&#58;&#115;&#117;&#112;&#112;&#111;&#114;&#116;&#64;&#106;&#117;&#115;&#116;&#110;&#111;&#116;&#101;&#46;&#99;&#99;">
                  <div className="mt-2 p-4 inline-block bg-green-500 rounded-xl shadow-lg">
                  ...
                  <h3 className="text-base font-normal text-gray-700">Email</h3>
                </a>
              </div>
            </div>
