          ...
          <div className="relative px-4 sm:px-6 lg:px-8">
            ...
            <div className="pt-12 max-w-prose mx-auto">
              <div className="grid grid-cols-1 gap-y-14 sm:grid-cols-3 sm:gap-y-0 sm:gap-x-8">
                ...
                <a className="block text-center rounded group focus:outline-none focus:ring-2 focus:ring-green-600" href="https://github.com/stxapps/justnote-client/issues" target="_blank" rel="noreferrer">
                  <div className="mt-2 p-4 inline-block bg-green-500 rounded-xl shadow-lg group-hover:bg-green-400">
