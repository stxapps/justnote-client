  ...
  return (
    <div className="w-full min-w-64 h-full overflow-y-auto">
      ...
      <div className="border-b border-gray-200 pl-4 pr-0 py-4 flex items-center justify-between sm:pl-6 lg:pl-8">
        ...
        <button type="button" className="group ml-3 inline-flex items-center pl-4 pr-1 border border-white text-sm font-medium text-gray-400 hover:text-gray-600 focus:outline-none-outer">
      ...
      <div>
        ...
        <div className="mt-6 px-4 sm:px-6 lg:px-8">
          <button className="w-full flex justify-center items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50">More</button>
        </div>
      </div>
    </div>
  );
