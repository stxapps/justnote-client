...
const NoteList = (props) => {
  ...
  return (
    <div className="relative w-full min-w-64 h-full flex flex-col">
      ...
      {noteListItems}
      {/* Add button */}
      {!isBulkEditing && (listName !== TRASH) && <button onClick={onAddBtnClick} className="absolute right-4 bottom-4 rounded-full bg-green-600 text-white w-16 h-16 shadow-md flex items-center justify-center hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-600 lg:hidden">
