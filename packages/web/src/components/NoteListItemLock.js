...
import { updatePopupUrlHash, updateSelectingNoteId, updateLockAction } from '../actions';
import {
    ...
    <div className={tailwind('group flex items-center rounded-sm py-4 pl-3 sm:pl-5')}>
      ...
      <div className={tailwind('min-w-0 flex-1')}>
        ...
        <div className={tailwind('flex items-center justify-between')}>
          <button tabIndex={bodyTabIndex} onClick={onContentBtnClick} className={tailwind('min-h-[2.625rem] w-full min-w-0 flex-1 rounded-sm focus:outline-none focus-visible:ring-2 focus-visible:ring-gray-400 focus-visible:ring-offset-2 blk:focus-visible:ring-gray-500 blk:focus-visible:ring-offset-gray-900')}>
