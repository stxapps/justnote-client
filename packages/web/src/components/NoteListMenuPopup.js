...
const NoteListMenuPopup = () => {
  ...
  if (isBulkEditing) {
    buttons = (
      <button onClick={onExitBtnClick} className={tailwind('group flex w-full items-center px-4 py-3 text-sm text-gray-700 hover:bg-gray-100 hover:text-gray-900 focus:bg-gray-100 focus:text-gray-900 focus:outline-none')} role="menuitem">
        <svg className={tailwind('mr-3 h-5 w-5 text-gray-400 group-hover:text-gray-500 group-focus:text-gray-500')} viewBox="0 0 20 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ...
    buttons = (
      <React.Fragment>
        <button onClick={onSelectBtnClick} className={tailwind('group flex w-full items-center px-4 py-3 text-sm text-gray-700 hover:bg-gray-100 hover:text-gray-900 focus:bg-gray-100 focus:text-gray-900 focus:outline-none')} role="menuitem">
          <svg className={tailwind('mr-3 h-5 w-5 text-gray-400 group-hover:text-gray-500 group-focus:text-gray-500')} viewBox="0 0 20 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        ...
        <button onClick={onSettingsBtnClick} className={tailwind('group flex w-full items-center px-4 py-3 text-sm text-gray-700 hover:bg-gray-100 hover:text-gray-900 focus:bg-gray-100 focus:text-gray-900 focus:outline-none')} role="menuitem">
          <svg className={tailwind('mr-3 h-5 w-5 text-gray-400 group-hover:text-gray-500 group-focus:text-gray-500')} viewBox="0 0 20 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        ...
        <button onClick={onSupportBtnClick} className={tailwind('group flex w-full items-center px-4 py-3 text-sm text-gray-700 hover:bg-gray-100 hover:text-gray-900 focus:bg-gray-100 focus:text-gray-900 focus:outline-none')} role="menuitem">
          <svg className={tailwind('mr-3 h-5 w-5 text-gray-400 group-hover:text-gray-500 group-focus:text-gray-500')} viewBox="0 0 20 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        ...
        <button onClick={onSignOutBtnClick} className={tailwind('group flex w-full items-center px-4 py-3 text-sm text-gray-700 hover:bg-gray-100 hover:text-gray-900 focus:bg-gray-100 focus:text-gray-900 focus:outline-none')} role="menuitem">
          <svg className={tailwind('mr-3 h-5 w-5 text-gray-400 group-hover:text-gray-500 group-focus:text-gray-500')} viewBox="0 0 20 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
  ...
  return (
    <AnimatePresence key="AP_NL_MenuPopup">
      ...
      <motion.div key="NL_MenuPopup_popup" style={popupStyle} className={tailwind('absolute rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5')} variants={popupFMV} initial="hidden" animate="visible" exit="hidden" role="menu" aria-orientation="vertical" aria-labelledby="options-menu">
