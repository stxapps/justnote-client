    ...
    <nav className="pl-3 pr-1 mt-6">
      <div className="space-y-1">
        <button className="bg-gray-200 text-gray-900 group flex items-center px-2 py-2 text-sm font-medium rounded-md w-full">
          <svg className="text-gray-500 mr-3 h-5 w-5" viewBox="0 0 20 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        ...
        <button className="text-gray-700 hover:text-gray-900 hover:bg-gray-50 group flex items-center px-2 py-2 text-sm font-medium rounded-md w-full">
          <svg className="text-gray-400 group-hover:text-gray-500 mr-3 h-5 w-5" viewBox="0 0 20 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
