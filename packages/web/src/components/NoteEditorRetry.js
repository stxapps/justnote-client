  ...
  return (
    <div className="w-full h-full bg-white overflow-auto">
      <div style={style} className="relative px-4 pb-4 sm:px-6 sm:pb-6">
        ...
        <p className="text-gray-500 text-sm font-normal">Please wait a moment and try again. If the problem persists, please <a className="underline rounded-sm hover:text-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-400" href="/support">contact us
