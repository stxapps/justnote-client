  ...
  return (
    <div className="w-full h-full bg-white overflow-auto">
      <div style={style} className="relative px-4 pb-4 sm:px-6 sm:pb-6">
        ...
        <p className="text-gray-500 text-sm font-normal">Please wait a moment and try again. If the problem persists, please <a className="underline rounded-sm hover:text-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-400" href={'/' + HASH_SUPPORT} target="_blank" rel="noreferrer">contact us
        ...
        <div className="pt-6 flex items-center">
          <button onClick={onRetryRetryBtnClick} type="button" className="flex items-center px-4 py-2 border border-gray-300 shadow-sm rounded-md text-sm text-gray-500 bg-white group hover:text-gray-600 hover:border-gray-400 focus:outline-none focus:border-gray-400 focus:ring-2 focus:ring-offset-2 focus:ring-gray-400">
          ...
          <button onClick={onRetryCancelBtnClick} className="ml-2 px-2 py-1.5 text-sm text-gray-500 rounded-md border border-white bg-white hover:text-gray-700 focus:outline-none focus:text-gray-700 focus:bg-gray-200">Cancel</button>
        </div>
