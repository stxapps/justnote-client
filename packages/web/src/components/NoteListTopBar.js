...
const NoteListTopBar = (props) => {
  ...
  const menuBtnSvg = (
    <svg className="w-10 p-2 rounded-full group-focus:bg-gray-200" viewBox="0 0 20 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    ...
    innerMenuBtn = (
      <React.Fragment>
        ...
        <div className="absolute top-0 left-0 h-full flex justify-start items-center lds-rotate">
          <svg className="w-10 h-10 text-green-600" viewBox="0 0 100 100" fill="none" stroke="currentColor" preserveAspectRatio="xMidYMid" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="pl-4 flex-1 min-w-0 flex items-center justify-between sm:pl-6">
          ...
          <div className="ml-4 flex">
            <button onClick={onSearchBtnClick} type="button" className="group inline-flex items-center px-1 border border-white text-sm text-gray-500 bg-white hover:text-gray-700 focus:outline-none focus:text-gray-700 lg:hidden">
              <div className="p-2.5 rounded group-focus:bg-gray-200">
            ...
            <button ref={menuBtn} onClick={onMenuBtnClick} type="button" className="group inline-flex items-center pr-2 border border-white text-sm text-gray-500 bg-white relative hover:text-gray-700 focus:outline-none focus:text-gray-700">
              {innerMenuBtn}
            </button>
          </div>
        </div>
