      ...
      <div className="h-16 border-b border-gray-200 flex items-center justify-between">
        ...
        <div className="pl-4 flex-1 flex items-center justify-between sm:pl-6 lg:pl-8">
          ...
          <div className="ml-4 flex">
            ...
            <button ref={menuBtn} onClick={onMenuBtnClick} type="button" className="group inline-flex items-center pl-2 pr-4 border border-white text-sm text-gray-500 bg-white hover:text-gray-600 focus:outline-none">
              <svg className="w-5 py-2 rounded-full group-hover:bg-gray-200 group-focus:ring-2 group-focus:ring-green-600" viewBox="0 0 20 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
