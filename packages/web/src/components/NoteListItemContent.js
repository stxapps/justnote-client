...
const NoteListItemContent = (props) => {
  ...
  return (
    <button onTouchStart={onTouchPress} onTouchMove={onTouchCancel} onTouchEnd={onTouchPressRelease} onTouchCancel={onTouchCancel} onMouseDown={onClickPress} onMouseMove={onClickCancel} onMouseUp={onClickPressRelease} onMouseLeave={onClickCancel} className="group w-full text-left rounded-sm flex items-center focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-green-600">
