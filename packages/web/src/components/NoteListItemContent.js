...
const NoteListItemContent = (props) => {
  ...
  return (
    <button onTouchStart={onTouchPress} onTouchMove={onTouchCancel} onTouchEnd={onTouchPressRelease} onTouchCancel={onTouchCancel} onMouseDown={onClickPress} onMouseMove={onClickCancel} onMouseUp={onClickPressRelease} onMouseLeave={onClickCancel} className="group w-full text-left rounded-sm flex items-center px-3 py-4 focus:outline-none focus-visible:bg-gray-100 sm:px-5">
