...
const _SettingsPopupData = (props) => {
  ...
  const {
    onSidebarOpenBtnClick, onToExportAllDataViewBtnClick, onToDeleteAllDataViewBtnClick
  } = props;
    ...
    actionPanel = (
      <div className="mt-6 mb-4">
        ...
        <p className="mt-6 text-base text-gray-500 leading-relaxed">
          ...
          <a className="underline hover:text-gray-700 focus:outline-none focus:ring-2 focus:ring-green-600 rounded" href="/support">
            contact us
  ...
  return (
    <div className="p-4 md:p-6 md:pt-4">
      <div className="border-b border-gray-200 md:border-b-0">
        <button onClick={onBackToDataViewBtnClick} className="mb-1 group focus:outline-none focus:ring-2 focus:ring-green-600 rounded md:pb-0">
          <span className="text-sm text-gray-500">{'<'} <span className="group-hover:underline">{safeAreaWidth < SM_WIDTH ? 'Settings / ' : ''}Data</span></span>
        </button>
  ...
  return (
    <div className="p-4 md:p-6 md:pt-4">
      ...
      <div className="mt-6 flex items-center">
        <input onChange={onConfirmInputChange} checked={didCheckConfirm} className="focus:ring-green-600 h-4 w-4 text-green-600 border-gray-300 rounded transition duration-150 ease-in-out focus:outline-none" id="confirm-input" type="checkbox" />
