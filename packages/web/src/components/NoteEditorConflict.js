          ...
          <div className="m-4 p-4 bg-red-50 rounded-md shadow-lg">
            <div className="flex">
              ...
              <div className="ml-3 lg:mt-0.5">
                ...
                <p className="mt-2.5 text-sm text-red-700">Please wait a moment and try again.<br />If the problem persists, please <a className="underline rounded-sm hover:text-red-800 focus:outline-none focus:ring-2 focus:ring-red-700" href={'/' + HASH_SUPPORT}>contact us
