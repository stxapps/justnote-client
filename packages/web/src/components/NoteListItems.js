  ...
  const renderEmpty = () => {
    ...
    if (searchString !== '') {
      return (
        <div className={tailwind('px-4 py-4 sm:px-6 sm:py-6')}>
          <p className={tailwind('text-base text-gray-600')}>Your search - <span className={tailwind('text-lg font-medium text-gray-800')}>{searchString}</span> - did not match any notes.</p>
          <p className={tailwind('pt-4 text-base text-gray-500 sm:pt-6')}>Suggestion:</p>
    ...
    if (listName === MY_NOTES) {
      return (
        <div className={tailwind('mt-32 mb-24 px-4 sm:px-6')}>
          <div className={tailwind('mx-auto flex h-20 w-20 items-center justify-center rounded-full bg-gray-200')}>
            <svg className={tailwind('h-10 w-10 text-gray-500')} viewBox="0 0 40 40" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
          ...
          <p className={tailwind('mt-6 text-center text-base font-semibold tracking-wide text-gray-800 lg:text-sm')}>No notes in {displayName}</p>
          <p style={{ lineHeight: '22px' }} className={tailwind('mt-4 text-center text-sm tracking-wide text-gray-500')}>Click <span className={tailwind('font-semibold')}>"+ New Note"</span> button to add a new note</p>
        </div>
      );
    }
    ...
    if (listName === TRASH) {
      return (
        <div className={tailwind('mt-32 mb-24 px-4 sm:px-6')}>
          <div className={tailwind('mx-auto flex h-20 w-20 items-center justify-center rounded-full bg-gray-200')}>
            <svg className={tailwind('h-10 w-10 text-gray-500')} viewBox="0 0 20 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
          ...
          <p className={tailwind('mt-6 text-center text-base font-semibold tracking-wide text-gray-800 lg:text-sm')}>No notes in {displayName}</p>
          <p style={{ lineHeight: '22px' }} className={tailwind('mt-4 text-center text-sm tracking-wide text-gray-500')}>Click <span className={tailwind('font-semibold')}>"Remove"</span> from the menu to move notes you don't need anymore here</p>
        </div>
      );
    }
    ...
    return (
      <div className={tailwind('mt-32 mb-24 px-4 sm:px-6')}>
        ...
        <p className={tailwind('mt-6 text-center text-base font-semibold tracking-wide text-gray-800 lg:text-sm')}>No notes in {displayName}</p>
        <p style={{ lineHeight: '22px' }} className={tailwind('mt-4 text-center text-sm tracking-wide text-gray-500')}>Click <span className={tailwind('font-semibold')}>{textName}</span> from the menu to move notes here</p>
      </div>
    );
  };
  ...
  const renderItems = () => {
    return (
      <div className={tailwind('mt-5')}>
        <ul className={tailwind('-my-5 divide-y divide-gray-200')}>
