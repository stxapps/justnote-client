  ...
  const _render = (content) => {
    ...
    return (
      <React.Fragment>
          ...
          <div style={closeBtnStyle} className="absolute top-0">
            <button onClick={onPopupCloseBtnClick} className="flex items-center justify-center h-12 w-12 group focus:outline-none" aria-label="Close settings popup">
              <div className="bg-white rounded-full">
                <svg className="h-5 w-5 text-gray-300 rounded group-hover:text-gray-500 group-focus:ring-2 group-focus:ring-gray-400 md:h-7 md:w-7" stroke="currentColor" fill="none" viewBox="0 0 24 24">
        ...
        {/* Sidebar for mobile */}
        <motion.div key="sidebar-for-mobile" className="fixed inset-0 md:hidden" variants={canvasFMV} initial={false} animate={animate}>
