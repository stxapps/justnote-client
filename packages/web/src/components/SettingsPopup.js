...
const SettingsPopup = () => {
  ...
  const _render = (content) => {
    ...
    return (
      <React.Fragment>
        <div className={tailwind('fixed inset-0 bg-white')}>
          ...
          <div style={closeBtnStyle} className={tailwind('absolute top-0')}>
            <button onClick={onPopupCloseBtnClick} className={tailwind('group flex h-12 w-12 items-center justify-center focus:outline-none')} aria-label="Close settings popup">
              <div className={tailwind('rounded-full bg-white')}>
                <svg className={tailwind('h-5 w-5 rounded text-gray-300 group-hover:text-gray-500 group-focus:ring-2 group-focus:ring-gray-400 md:h-7 md:w-7')} stroke="currentColor" fill="none" viewBox="0 0 24 24">
        ...
        {/* Sidebar for mobile */}
        <motion.div key="sidebar-for-mobile" className={tailwind('fixed inset-0 md:hidden')} variants={canvasFMV} initial={false} animate={animate}>
          <div className={tailwind('relative flex h-full')}>
            ...
            <div className={tailwind('absolute top-0 right-0')}>
              <button onClick={onPopupCloseBtnClick} className={tailwind('group flex h-12 w-12 items-center justify-center focus:outline-none')} aria-label="Close settings popup">
                <svg className={tailwind('h-5 w-5 rounded text-gray-300 group-hover:text-gray-500 group-focus:ring-2 group-focus:ring-gray-400')} stroke="currentColor" fill="none" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M6 18L18 6M6 6l12 12" />
                </svg>
              </button>
            </div>
