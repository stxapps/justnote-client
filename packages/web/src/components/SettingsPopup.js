            ...
            <div ref={overflowPanel} className="h-full overflow-y-scroll">
              <div className="relative max-w-6xl mx-auto">
                ...
                <div className="hidden absolute top-0 right-0 md:block">
                  <button onClick={onPopupCloseBtnClick} className="flex items-center justify-center h-12 w-12 group focus:outline-none" aria-label="Close settings popup">
                    <svg className="h-7 w-7 text-gray-300 rounded group-hover:text-gray-500 group-focus:ring-2 group-focus:ring-gray-400" stroke="currentColor" fill="none" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M6 18L18 6M6 6l12 12" />
                    </svg>
                  </button>
                </div>
