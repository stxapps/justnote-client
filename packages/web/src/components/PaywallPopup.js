        ...
        <div style={{ minHeight: safeAreaHeight }} className="flex items-end justify-center pt-4 px-4 pb-20 text-center sm:block sm:p-0">
          ...
          <motion.div className="relative inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6" variants={dialogFMV} initial="hidden" animate="visible" exit="hidden">
            ...
            <div className="mt-5 sm:mt-6 sm:flex sm:justify-center sm:items-center">
              <button onClick={onOkBtnClick} className="w-full inline-flex justify-center rounded-md border border-gray-800 py-2 bg-gray-800 text-base font-medium text-white shadow-sm hover:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-600 sm:text-sm" type="button">More info</button>
              <button onClick={onCancelBtnClick} style={cancelBtnStyle} className="mt-3 w-full inline-flex justify-center rounded-md border border-gray-400 bg-white text-base font-normal text-gray-500 shadow-sm hover:text-gray-600 hover:border-gray-500 focus:outline-none focus:border-gray-500 focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 sm:mt-0 sm:ml-14 sm:w-40 sm:text-sm" type="button">Cancel</button>
            </div>
          </motion.div>
        </div>
      </div>
