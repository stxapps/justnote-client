...
const NoteCommands = (props) => {
  ...
  return (
    <React.Fragment>
      ...
      {isRemoveBtnShown && <button onClick={onRemoveBtnClick} type="button" className={`group inline-flex items-center h-full pl-0 pr-1 border border-white text-sm text-gray-500 bg-white hover:text-gray-600 focus:outline-none lg:px-2 lg:py-2 lg:border-gray-300 lg:rounded-md lg:shadow-sm lg:hover:bg-gray-50 lg:focus:ring-2 lg:focus:ring-green-600 ${btnClassNames}`}>
        <div className="p-2 rounded group-hover:bg-gray-200 group-focus:ring-2 group-focus:ring-green-600 lg:p-0 lg:group-hover:bg-transparent lg:group-focus:ring-transparent">
          <svg className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      ...
      {isRestoreBtnShown && <button onClick={onRestoreBtnClick} type="button" className={`group inline-flex items-center h-full pl-0 pr-1 border border-white text-sm text-gray-500 bg-white hover:text-gray-600 focus:outline-none lg:px-2 lg:py-2 lg:border-gray-300 lg:rounded-md lg:shadow-sm lg:hover:bg-gray-50 lg:focus:ring-2 lg:focus:ring-green-600 ${btnClassNames}`}>
        <div className="p-2 rounded group-hover:bg-gray-200 group-focus:ring-2 group-focus:ring-green-600 lg:p-0 lg:group-hover:bg-transparent lg:group-focus:ring-transparent">
          <svg className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      ...
      {isDeleteBtnShown && <button onClick={onDeleteBtnClick} type="button" className={`group inline-flex items-center h-full pl-0 pr-1 border border-white text-sm text-gray-500 bg-white hover:text-gray-600 focus:outline-none lg:px-2 lg:py-2 lg:border-gray-300 lg:rounded-md lg:shadow-sm lg:hover:bg-gray-50 lg:focus:ring-2 lg:focus:ring-green-600 ${btnClassNames}`}>
        <div className="p-2 rounded group-hover:bg-gray-200 group-focus:ring-2 group-focus:ring-green-600 lg:p-0 lg:group-hover:bg-transparent lg:group-focus:ring-transparent">
      ...
      {isMoveToBtnShown && <button ref={moveToBtn} onClick={onMoveToBtnClick} type="button" className={`group inline-flex items-center h-full pl-0 pr-1 border border-white text-sm text-gray-500 bg-white hover:text-gray-600 focus:outline-none lg:px-2 lg:py-2 lg:border-gray-300 lg:rounded-md lg:shadow-sm lg:hover:bg-gray-50 lg:focus:ring-2 lg:focus:ring-green-600 ${btnClassNames}`}>
        <div className="p-2 rounded group-hover:bg-gray-200 group-focus:ring-2 group-focus:ring-green-600 lg:p-0 lg:group-hover:bg-transparent lg:group-focus:ring-transparent">
          <svg className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
