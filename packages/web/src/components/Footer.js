    ...
    <footer className={tailwind('bg-white')}>
      <div className={tailwind('mx-auto max-w-7xl overflow-hidden py-12 px-4 sm:px-6 lg:px-8')}>
        ...
        <div className={tailwind('mt-8 flex items-center justify-center space-x-6')}>
          ...
          <a className={tailwind('rounded-sm text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-1')} href="https://www.threads.net/@justnote.cc" target="_blank" rel="noreferrer">
          ...
          <a className={tailwind('rounded-sm text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-1')} href="https://github.com/stxapps/justnote-client" target="_blank" rel="noreferrer">
