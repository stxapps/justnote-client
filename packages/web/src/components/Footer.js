    ...
    <footer className="bg-white">
      <div className="max-w-7xl mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8">
        ...
        <div className="mt-8 flex justify-center space-x-6">
          ...
          <a className="text-gray-400 rounded-sm hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-gray-400" href="https://github.com/justnotecc" target="_blank" rel="noreferrer">
