...
import {
  ScrollView, View, TouchableOpacity, TouchableWithoutFeedback, Animated,
...
const SettingsPopup = () => {
  ...
  const _render = (content) => {
    ...
    return (
      <View {...viewPanResponder.panHandlers} style={[tailwind('absolute inset-0 bg-white blk:bg-gray-900'), canvasStyle]}>
  ...
  const renderConflictView = () => {
    ...
    return (
      <View style={[tailwind('absolute inset-0 bg-white blk:bg-gray-900'), canvasStyle]}>
        <View style={tailwind('flex-1')}>
