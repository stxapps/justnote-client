  ...
  return (
    <View style={tailwind('mt-6 mb-4 md:mt-0')}>
      ...
      <View style={tailwind('pt-3 lg:flex-row lg:justify-between lg:pt-5')}>
        <View style={tailwind('flex-row items-center justify-start lg:w-44')}>
        ...
        <View style={tailwind('flex-row items-center justify-start pt-2 lg:w-48 lg:pt-0')}>
          <Svg style={tailwind('flex-shrink-0 flex-grow-0 font-normal text-green-600 blk:text-green-400')} width={20} height={20} viewBox="0 0 20 20" fill="currentColor">
            <Path fillRule="evenodd" d="M16.704 4.153a.75.75 0 01.143 1.052l-8 10.5a.75.75 0 01-1.127.075l-4.5-4.5a.75.75 0 011.06-1.06l3.894 3.893 7.48-9.817a.75.75 0 011.05-.143z" clipRule="evenodd" />
          </Svg>
          <Text style={tailwind('ml-3 text-base font-medium text-gray-500 blk:text-gray-400')}>Lock lists & notes</Text>
        </View>
        <View style={tailwind('flex-row items-center justify-start pt-2 lg:w-44 lg:pt-0')}>
          <Svg style={tailwind('flex-shrink-0 flex-grow-0 font-normal text-green-600 blk:text-green-400')} width={20} height={20} viewBox="0 0 20 20" fill="currentColor">
            <Path fillRule="evenodd" d="M16.704 4.153a.75.75 0 01.143 1.052l-8 10.5a.75.75 0 01-1.127.075l-4.5-4.5a.75.75 0 011.06-1.06l3.894 3.893 7.48-9.817a.75.75 0 011.05-.143z" clipRule="evenodd" />
          </Svg>
          <Text style={tailwind('ml-3 text-base font-medium text-gray-500 blk:text-gray-400')}>More font sizes</Text>
        </View>
      </View>
      <View style={tailwind('lg:flex-row lg:justify-between lg:pt-5')}>
        <View style={tailwind('flex-row items-center justify-start pt-2 lg:w-44 lg:pt-0')}>
          <Svg style={tailwind('flex-shrink-0 flex-grow-0 font-normal text-green-600 blk:text-green-400')} width={20} height={20} viewBox="0 0 20 20" fill="currentColor">
            <Path fillRule="evenodd" d="M16.704 4.153a.75.75 0 01.143 1.052l-8 10.5a.75.75 0 01-1.127.075l-4.5-4.5a.75.75 0 011.06-1.06l3.894 3.893 7.48-9.817a.75.75 0 011.05-.143z" clipRule="evenodd" />
          </Svg>
        ...
        <View style={tailwind('flex-row items-center justify-start pt-2 lg:w-48 lg:pt-0')}>
          ...
          <Text style={tailwind('ml-3 text-base font-medium text-gray-500 blk:text-gray-400')}>Custom date format</Text>
        </View>
        <View style={tailwind('flex-row items-center justify-start pt-2 lg:w-44 lg:pt-0')}>
          <Svg style={tailwind('flex-shrink-0 flex-grow-0 font-normal text-green-600 blk:text-green-400')} width={20} height={20} viewBox="0 0 20 20" fill="currentColor">
            <Path fillRule="evenodd" d="M16.704 4.153a.75.75 0 01.143 1.052l-8 10.5a.75.75 0 01-1.127.075l-4.5-4.5a.75.75 0 011.06-1.06l3.894 3.893 7.48-9.817a.75.75 0 011.05-.143z" clipRule="evenodd" />
...
const IapPurchased = (props) => {
  ...
  if (purchase.source === APPSTORE) {
    ...
    appStoreLink = (
      <Text onPress={() => Linking.openURL('https://play.google.com/store/account/subscriptions?sku=com.justnotecc.supporter&package=com.justnotecc')} style={tailwind('text-base font-normal leading-6.5 text-gray-500 underline blk:text-gray-400')}>Google Play</Text>
    );
  ...
  if (purchase.status === ACTIVE) {
    ...
    infoText = (
      <React.Fragment>
        <Text style={tailwind('mt-4 text-base font-normal leading-6.5 text-gray-500 blk:text-gray-400')}>Thank you very much for supporting us. You&apos;ve unlocked extra features: tags, lock lists & notes, more font sizes, dark appearance, custom date format, section by month, and pin to the top.</Text>
    ...
    infoText = (
      <React.Fragment>
        ...
        <View style={tailwind('mt-4')}>
          <Text style={tailwind('text-base font-normal leading-6.5 text-gray-500 blk:text-gray-400')}>     <Text style={tailwind('text-base font-normal leading-6.5 text-red-600 blk:text-red-500')}>Your subscription has expired.</Text> Please go to {appStoreLink} now to renew it to support us and unlock extra features.
          </Text>
          <View style={[tailwind('absolute'), { top: 3, left: 0 }]}>
            <Svg style={tailwind('font-normal text-red-500 blk:text-red-500')} width={20} height={20} viewBox="0 0 20 20" fill="currentColor">
              <Path fillRule="evenodd" clipRule="evenodd" d="M18 10C18 14.4183 14.4183 18 10 18C5.58172 18 2 14.4183 2 10C2 5.58172 5.58172 2 10 2C14.4183 2 18 5.58172 18 10ZM11 14C11 14.5523 10.5523 15 10 15C9.44772 15 9 14.5523 9 14C9 13.4477 9.44772 13 10 13C10.5523 13 11 13.4477 11 14ZM10 5C9.44772 5 9 5.44772 9 6V10C9 10.5523 9.44772 11 10 11C10.5523 11 11 10.5523 11 10V6C11 5.44772 10.5523 5 10 5Z" />
