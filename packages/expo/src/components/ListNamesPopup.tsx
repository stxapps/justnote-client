...
const ListNamesPopup = () => {
  ...
  let popupHeight = 44 + (44 * maxChildrenSize) + 48;
  if (popupHeight > safeAreaHeight - 16) {
    popupHeight = getLastHalfHeight(
      Math.min(popupHeight, safeAreaHeight - 16), 44, 0, 48, 0.5
    );
  }
  ...
  const _render = () => {
    ...
    return (
      <React.Fragment>
        ...
        <View style={tailwind('h-12 flex-shrink-0 flex-grow-0 flex-row items-center justify-end border-t border-gray-200 px-3 blk:border-gray-600')}>
