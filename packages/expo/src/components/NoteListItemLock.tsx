...
const NoteListItemLock = (props) => {
  ...
  return (
    <View style={tailwind('w-full flex-row items-center rounded-xs py-4 pl-3 sm:pl-5')}>
      ...
      <View style={tailwind('flex-1')}>
        {title && <View style={tailwind('pr-3')}>
          <TouchableOpacity activeOpacity={1.0} onPress={onContentBtnClick} style={tailwind('w-full flex-row items-center justify-between rounded-xs')}>
            <View style={tailwind('flex-1')}>
        ...
        <View style={tailwind('flex-row items-center justify-between')}>
          <TouchableOpacity activeOpacity={1.0} onPress={onContentBtnClick} style={[tailwind('w-full flex-1 items-start justify-center rounded-xs'), { minHeight: 42 }]}>
