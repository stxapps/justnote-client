    ...
    <View style={tailwind('h-full w-full bg-white blk:bg-gray-900')}>
      <ScrollView>
        <View style={[tailwind('px-4 pb-4 sm:px-6 sm:pb-6'), style]}>
          ...
          <Text style={tailwind('text-sm font-normal text-gray-500 blk:text-gray-400')}>Please wait a moment and try again. If the problem persists, please <Text onPress={() => Linking.openURL(DOMAIN_NAME + '/' + HASH_SUPPORT)} style={tailwind('text-sm font-normal text-gray-500 underline blk:text-gray-400')}>contact us</Text>.</Text>
          <View style={tailwind('flex-row items-center pt-6')}>
            <TouchableOpacity onPress={onRetryRetryBtnClick} style={tailwind('flex-row items-center rounded-md border border-gray-300 bg-white px-4 py-2 shadow-xs blk:border-gray-600 blk:bg-gray-900')}>
