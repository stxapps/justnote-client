...
import {
  DOMAIN_NAME, HASH_LANDING, HASH_LANDING_MOBILE, HASH_ABOUT, HASH_TERMS, HASH_PRIVACY,
  HASH_SUPPORT, BLK_MODE,
} from '../types/const';
    ...
    <View style={tailwind('p-4 md:p-6')}>
      ...
      <View style={tailwind('mt-5 md:mt-0')}>
        <View style={tailwind('hidden md:flex')}>
          {themeMode === BLK_MODE ? <LogoBlk width={28} height={28} /> : <Logo width={28} height={28} />}
        </View>
      ...
      <View style={tailwind('-ml-2 items-start justify-start pt-8 md:flex-row')}>
        ...
        <View style={tailwind('hidden py-2 md:ml-10 lg:flex')}>
          <TouchableOpacity onPress={() => Linking.openURL('https://docs.justnote.cc')} style={tailwind('px-2 py-1')}>
      ...
      <View style={tailwind('flex-row items-center justify-start pt-14')}>
        <TouchableOpacity onPress={() => Linking.openURL('https://x.com/justnotecc')} style={tailwind('my-0.5')}>
        ...
        <TouchableOpacity onPress={() => Linking.openURL('https://www.threads.net/@justnote.cc')} style={tailwind('ml-8')}>
        ...
        <TouchableOpacity onPress={() => Linking.openURL('https://github.com/stxapps/justnote-client')} style={tailwind('ml-8')}>
      ...
      <View style={tailwind('items-start justify-start pt-16 lg:flex-row lg:justify-between')}>
        ...
        <Text style={tailwind('text-base font-normal text-gray-400 blk:text-gray-500')}>All rights reserved.</Text>
      </View>
    </View>
  );
};
