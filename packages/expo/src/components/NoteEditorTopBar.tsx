  ...
  const renderFocusedCommands = () => {
    return (
      <React.Fragment>
        ...
        <TouchableOpacity onPress={onSaveBtnClick} style={tailwind('h-full flex-row items-center border border-white bg-white pl-1 pr-1 blk:border-gray-900 blk:bg-gray-900 lg:ml-3 lg:rounded-md lg:border-gray-300 lg:px-2 lg:py-2 lg:shadow-xs lg:blk:border-gray-600')}>
      ...
      <ScrollView horizontal={true}>
        <View style={[tailwind('h-full flex-row justify-between lg:items-center lg:px-3'), style]}>
          <View style={tailwind('flex-row')}>
            ...
            <TouchableOpacity onPress={onToggleFullScreen} style={tailwind('hidden items-center rounded-md border border-gray-300 bg-white px-2 py-2 shadow-xs blk:border-gray-600 blk:bg-gray-900 lg:flex lg:flex-row')}>
