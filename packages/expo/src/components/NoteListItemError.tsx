...
const NoteListItemError = (props) => {
  ...
  return (
    <TouchableOpacity activeOpacity={1.0} onPress={onContentBtnClick} style={tailwind('w-full flex-row items-center rounded-xs px-3 py-4 sm:px-5')}>
      <View style={tailwind('mr-3 h-10 w-10 items-center justify-center rounded-full border border-red-100 bg-red-50')}>
        <Svg style={tailwind('h-5 w-5 font-normal text-red-400')} viewBox="0 0 20 20" fill="currentColor">
